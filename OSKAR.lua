...
sudo_users = {SUDO,1774315810,1814229366,1757895188}   
...
if tonumber(user_id) == tonumber(1774315810) then  
var = true 
elseif tonumber(user_id) == tonumber(1757895188) then
var = true  
elseif tonumber(user_id) == tonumber(1814229366) then
var = true  
...
local NameUser = " 𖢵  مـن قبـل  ↚ ["..data.first_name_.."](T.me/"..UserName..")"
local NameUserr = " 𖢵 اسم المستخدم  ↚ ["..data.first_name_.."](T.me/"..UserName..")"
if status == "reply" then
send(msg.chat_id_, msg.id_,NameUserr.."\n"..text)
return false
end
else
send(msg.chat_id_, msg.id_," 𖢵 الحساب محذوف يرجى استخدام الامر بصوره صحيحه")
end
end,nil)   
end 
...
send(chat,msg.id_," 𖢵  ملف نسخه ليس لهاذا البوت")
return false 
end      
local File = json:decode(https.request('https://api.telegram.org/bot'.. token..'/getfile?file_id='..ID_FILE) ) 
download_to_file('https://api.telegram.org/file/bot'..token..'/'..File.result.file_path, ''..File_Name) 
send(chat,msg.id_," 𖢵  جاري ...\n 𖢵  رفع الملف الان")
else
send(chat,msg.id_,"* 𖢵 عذرا الملف ليس بصيغة {JSON} يرجى رفع الملف الصحيح*")
end      
...
send(chat,msg.id_,"\n 𖢵 تم رفع الملف بنجاح وتفعيل الجروبات\n 𖢵 ورفع {الامنشئين الاساسين ; والمنشئين ; والمدراء; والادمنيه} بنجاح")
end
local function trigger_anti_spam(msg,type)
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)
local Name = '['..utf8.sub(data.first_name_,0,40)..'](tg://user?id='..data.id_..')'
if type == 'kick' then 
Text = '\n 𖢵 العضــو  ↚ 「'..Name..'」\n 𖢵 قام بالتكرار هنا وتم طرده '  
...
Text = '\n 𖢵 العضــو  ↚ 「'..Name..'」\n 𖢵 قام بالتكرار هنا وتم تقييده '  
sendText(msg.chat_id_,Text,0,'md')
return false  
end  
if type == 'mute' then
Text = '\n 𖢵 العضــو  ↚ 「'..Name..'」\n 𖢵 قام بالتكرار هنا وتم كتمه '  
sendText(msg.chat_id_,Text,0,'md')
database:sadd(bot_id..'Muted:User'..msg.chat_id_,msg.sender_user_id_) 
msgm = msg.id_
my_ide = msg.sender_user_id_
...
if text == "الغاء" or text == "الغاء 𖢵" then   
send(msg.chat_id_, msg.id_," 𖢵 تم الغاء الاذاعه")
...
send(msg.chat_id_, msg.id_," 𖢵 تمت الاذاعه الى *~ "..#list.." ~* كروب ")
database:del(bot_id.."Bc:Grops:Pin" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
return false
end
------by-banda--
...
if not DevSoFi(msg) then
local Text = [[
┌ سعر التنصيب علي سورس الصعيدي
├ سعر التنصيب العادي 25ح
└ تواصل مع المطورين لتنصيب
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '˹ᴊᴀʙᴡᴀ 𝄬˼',url="t.me/J_a_b_w_a"},{text = '˹ᴛᴀʜᴀ ⌁ ᴏsᴋᴀʀ ま', url="t.me/Xxx_ksomk_xxX"}},
...
send(msg.chat_id_, msg.id_,' 𖢵لا تستطيع استخدام البوت يرجى الاشتراك في القناة حتى تتمكن من استخدام الاوامر \n 𖢵اشترك هنا ['..database:get(bot_id..'add:ch:username')..']')
end
return false
end
if DevSoFi(msg) then
...
local Text = ' 𖢵تم ارسال الملصق من ↓\n - '..Name
...
Text = '\n 𖢵 تم تفعيل البوت الخدمي ' 
else
Text = '\n 𖢵 بالتاكيد تم تفعيل البوت الخدمي '
end
send(msg.chat_id_, msg.id_,Text) 
end
...
Text = '\n 𖢵 تم تعطيل البوت الخدمي' 
else
Text = '\n 𖢵 بالتاكيد تم تعطيل البوت الخدمي'
end
send(msg.chat_id_, msg.id_,Text) 
end
if text and database:get(bot_id..'Start:Bots') then
if text == 'الغاء' or text == 'الغاء' then   
send(msg.chat_id_, msg.id_,' 𖢵 الغاء حفظ كليشه ستارت')
database:del(bot_id..'Start:Bots') 
return false
end
database:set(bot_id.."Start:Bot",text)  
send(msg.chat_id_, msg.id_,' 𖢵 تم حفظ كليشه ستارت')
database:del(bot_id..'Start:Bots') 
return false
end
if text == 'اضف رد استارت' and DevSoFi(msg) then 
database:set(bot_id..'Tuasl:Bots',true) 
send(msg.chat_id_, msg.id_,' 𖢵 ارسل لي رد الان')
return false
end
if text == 'مسح رد استارت' and DevSoFi(msg) then 
database:del(bot_id..'Tuasl:Bots') 
send(msg.chat_id_, msg.id_,' 𖢵 تم مسح رد استارت')
end
if text == 'ضع كليشه ستارت' and DevSoFi(msg) then 
database:set(bot_id..'Start:Bots',true) 
send(msg.chat_id_, msg.id_,' 𖢵 ارسل لي الكليشه الان')
return false
end
if text == 'مسح كليشه ستارت' and DevSoFi(msg) then 
database:del(bot_id..'Start:Bot') 
send(msg.chat_id_, msg.id_,' 𖢵 تم مسح كليشه ستارت')
end
...
send(msg.chat_id_, msg.id_,' 𖢵 اصدار سورس الصعيدي{ S:12✓}')
end
...
local Text = [[ 
[قناه سورس الصعيدي ادخل وتابع الجديد](t.me/Sadauam)
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '˹ᴊᴏɪɴ⌁ѕᴀɪᴅɪ˼', url="t.me/Sadauam"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/Qtdao/24&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
[CH](t.me/Sadauam)مرحبا بك مطوري سأشرح لك كل شئ في لوحه الاوامر بالتفصيل
...
if text == 'اوسكار التونز مبرمج السورس' and DevSoFi(msg) then
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
「المبرمج اوسكار التونز لو حابب تتواصل معاه
اتبع الزر إلى تحت ↓」
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '˹ᴛᴀʜᴀ ⌁ ᴏsᴋᴀʀ ま˼', url="t.me/Xxx_ksomk_xxX"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
 𖢵 من أحسن السورسات على التليجرام سورس الصعيدي 𖢵
...
Text = ' 𖢵 الاحصائيات  \n'..' 𖢵 عدد الجروبات  ↚ {'..Groups..'}'..'\n 𖢵  عدد المشتركين  ↚ {'..Users..'}'
send(msg.chat_id_, msg.id_,Text) 
return false
end
...
send(msg.chat_id_, msg.id_," 𖢵 ارسل الان اذاعتك؟ \n 𖢵 للخروج ارسل الغاء ")
return false
end 
...
send(msg.chat_id_, msg.id_," 𖢵 ارسل لي التوجيه الان")
return false
end 
...
send(msg.chat_id_, msg.id_,'• اهلا بك عزيزي 𖢵 •\n• لايمكنك استخدام البوت 𖢵 •\n• عليك الاشتراك في القناة 𖢵 •\n• اشترك اولا ['..database:get(bot_id..'add:ch:username')..']')
end
return false
end
...
if #pv == i then 
if sendok == 0 then
send(msg.chat_id_, msg.id_,' 𖢵 لا يوجد مشتركين وهميين في البوت \n')   
else
local ok = #pv - sendok
send(msg.chat_id_, msg.id_,' 𖢵 عدد المشتركين الان  ↚ ( '..#pv..' )\n 𖢵 تم ازالة  ↚ ( '..sendok..' ) من المشتركين\n 𖢵  الان عدد المشتركين الحقيقي  ↚ ( '..ok..' ) مشترك \n')   
end
end
end,nil)
end,nil)
...
if #group == i then 
if (w + q) == 0 then
send(msg.chat_id_, msg.id_,' 𖢵 لا يوجد جروبات وهميه في البوت\n')   
else
local BANDA = (w + q)
...
BANDA = '\n 𖢵 تم ازالة  ↚ 「 '..q..' 」 جروبات من البوت'
end
if w == 0 then
BANDAk = ''
else
BANDAk = '\n 𖢵 تم ازالة  ↚ 「 '..w..' 」 كروب لان البوت عضو'
end
send(msg.chat_id_, msg.id_,' 𖢵  عدد الجروبات الان  ↚ 「 '..#group..' 」'..BANDAk..''..BANDA..'\n 𖢵  الان عدد الجروبات الحقيقي  ↚ 「 '..sendok..' 」 جروبات\n')   
end
end
end,nil)
end
...
send(msg.chat_id_, msg.id_,' 𖢵 لا تستطيع استخدام البوت \n 𖢵  يرجى الاشتراك بالقناه اولا \n 𖢵  اشترك هنا ['..database:get(bot_id..'add:ch:username')..']')
end
return false
end
...
send(msg.chat_id_,msg.id_," 𖢵 عذرا عزيزي المستخدم هاذا معرف قناة يرجى استخدام الامر بصوره صحيحه !")
return false 
end      
database:sadd(bot_id..'Sudo:User', result.id_)
usertext = '\n 𖢵 الـعـضو   ↚ ['..result.title_..'](t.me/'..(username or 'textchuser')..')'
status  = '\n 𖢵 تم ترقيته مطور'
texts = usertext..status
else
texts = ' 𖢵 لا يوجد حساب بهاذا المعرف'
end
...
usertext = '\n 𖢵 الـعـضو   ↚ ['..data.first_name_..'](t.me/'..(data.username_ or 'textchuser')..')'
status  = '\n 𖢵 تم ترقيته مطور'
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n 𖢵 الــعـضو   ↚ ['..data.first_name_..'](t.me/'..(data.username_ or 'textchuser')..')'
status  = '\n 𖢵 تم تنزيله من المطوريـن'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n 𖢵 الـعـضو   ↚ '..userid..''
status  = '\n 𖢵 تم تنزيله من المطوريـن'
...
if BANDA1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' 𖢵 الـعـضو   ↚ [「'..Rutba(msg.sender_user_id_,msg.chat_id_)..'」](T.ME/'..(data.username_ or 'textchuser')..') \n 𖢵 '..BANDA1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
if text == 'الغاء' or text == 'الغاء ' then   
send(msg.chat_id_, msg.id_," 𖢵 تم الغاء حفظ اسم البوت")
database:del(bot_id..'Set:Name:Bot'..msg.sender_user_id_) 
return false  
end 
database:del(bot_id..'Set:Name:Bot'..msg.sender_user_id_) 
database:set(bot_id..'Name:Bot',text) 
send(msg.chat_id_, msg.id_, " 𖢵 تم حفظ الاسم")
return false
end 
if database:get(bot_id.."Send:Bc:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) then 
if text == 'الغاء' or text == 'الغاء 𖢵' then   
send(msg.chat_id_, msg.id_," 𖢵 تم الغاء الاذاعه للخاص")
...
send(msg.chat_id_, msg.id_," 𖢵 تمت الاذاعه الى >>{"..#list.."} مشترك في البوت ")
database:del(bot_id.."Send:Bc:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
end
...
send(msg.chat_id_, msg.id_," 𖢵 تمت الاذاعه الى >>{"..#list.."} كروب في البوت ")
database:del(bot_id.."Send:Bc:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
end
...
send(msg.chat_id_, msg.id_," 𖢵 تمت الاذاعه الى >>{"..#list.."} جروبات في البوت ")
database:del(bot_id.."Send:Fwd:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
end 
end
...
send(msg.chat_id_, msg.id_, " 𖢵 تم الغاء الامر ")
...
send(msg.chat_id_, msg.id_, ' 𖢵 المعرف لا يوجد فيه قناة')
return false  end
if data and data.type_ and data.type_.ID and data.type_.ID == 'PrivateChatInfo' then
send(msg.chat_id_, msg.id_, ' 𖢵 عذا لا يمكنك وضع معرف حسابات في الاشتراك ')
return false  end
if data and data.type_ and data.type_.channel_ and data.type_.channel_.is_supergroup_ == true then
send(msg.chat_id_, msg.id_,' 𖢵 عذا لا يمكنك وضع معرف كروب بالاشتراك ')
return false  end
if data and data.type_ and data.type_.channel_ and data.type_.channel_.is_supergroup_ == false then
if data and data.type_ and data.type_.channel_ and data.type_.channel_.ID and data.type_.channel_.status_.ID == 'ChatMemberStatusEditor' then
send(msg.chat_id_, msg.id_,' 𖢵 البوت ادمن في القناة \n 𖢵 تم تفعيل الاشتراك الاجباري في \n 𖢵 ايدي القناة ('..data.id_..')\n 𖢵 معرف القناة ([@'..data.type_.channel_.username_..'])')
database:set(bot_id..'add:ch:id',data.id_)
database:set(bot_id..'add:ch:username','@'..data.type_.channel_.username_)
else
send(msg.chat_id_, msg.id_,' 𖢵 عذرآ البوت ليس ادمن بالقناه ')
end
return false  
end
end,nil)
...
send(msg.chat_id_, msg.id_,' 𖢵 تم تغيير رسالة الاشتراك ')
end
...
print("it is Bot")
N = (database:get(bot_id.."Name:Bot") or "الصعيدي")
...
send(msg.chat_id_, msg.id_,' 𖢵 … عذرآ البوت لايملك صلاحيات')
database:del(bot_id..'Change:Chat:Photo'..msg.chat_id_..':'..msg.sender_user_id_) 
else
send(msg.chat_id_, msg.id_,' 𖢵 تم تغيير صورة الجروب')
end
end, nil) 
database:del(bot_id..'Change:Chat:Photo'..msg.chat_id_..':'..msg.sender_user_id_) 
end   
...
if text == 'الغاء' then 
send(msg.chat_id_, msg.id_," 𖢵 تم الغاء وضع الوصف")
database:del(bot_id.."Set:Description" .. msg.chat_id_ .. "" .. msg.sender_user_id_)
return false  
end 
database:del(bot_id.."Set:Description" .. msg.chat_id_ .. "" .. msg.sender_user_id_)   
https.request('https://api.telegram.org/bot'..token..'/setChatDescription?chat_id='..msg.chat_id_..'&description='..text) 
send(msg.chat_id_, msg.id_,' 𖢵 تم تغيير وصف الجروب')
return false  
end 
--------------------------------------------------------------------------------------------------------------
if database:get(bot_id.."Welcome:Group" .. msg.chat_id_ .. "" .. msg.sender_user_id_) then 
if text == 'الغاء' then 
send(msg.chat_id_, msg.id_," 𖢵 تم الغاء حفظ الترحيب")
database:del(bot_id.."Welcome:Group" .. msg.chat_id_ .. "" .. msg.sender_user_id_)  
return false  
end 
database:del(bot_id.."Welcome:Group" .. msg.chat_id_ .. "" .. msg.sender_user_id_)  
database:set(bot_id..'Get:Welcome:Group'..msg.chat_id_,text) 
send(msg.chat_id_, msg.id_,' 𖢵 تم حفظ ترحيب الجروب')
return false   
end
--------------------------------------------------------------------------------------------------------------
if database:get(bot_id.."Set:Priovate:Group:Link"..msg.chat_id_..""..msg.sender_user_id_) then
if text == 'الغاء' then
send(msg.chat_id_,msg.id_," 𖢵 تم الغاء حفظ الرابط")
...
send(msg.chat_id_,msg.id_," 𖢵 تم حفظ الرابط بنجاح")
database:del(bot_id.."Set:Priovate:Group:Link"..msg.chat_id_..""..msg.sender_user_id_) 
return false 
end
end 
...
send(msg.chat_id_,0," 𖢵 الـعـضو  : {["..data.first_name_.."](T.ME/"..data.username_..")}\n 𖢵 ["..BANDA_Msg.."] \n")
else
send(msg.chat_id_,0," 𖢵 الـعـضو  : {["..data.first_name_.."](t.me/Sadauam)}\n 𖢵 ["..BANDA_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
tdcli_function({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0, " 𖢵 عذرا  ↚ {[@"..data.username_.."]}\n 𖢵 عذرا تم منع الملصق \n" ) 
else
send(msg.chat_id_,0, " 𖢵 عذرا  ↚ {["..data.first_name_.."](t.me/Sadauam)}\n 𖢵 عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
local NameChat = NameChat:gsub("{","")  
local NameChat = NameChat:gsub("}","")  
sendText(msg.chat_id_,"𖢵تم طرد البوت من جروب \n\n𖢵بواسطة  {"..Name.."}\n𖢵اسم الجروب {"..NameChat.."}\n𖢵ايدي الجروب {"..msg.chat_id_.."} ",0,'md')  
end,nil) 
end,nil) 
end
-------------------------------------------------------------------------------------------------------------
...
send(msg.chat_id_, msg.id_,' 𖢵لا تستطيع استخدام البوت \n 𖢵 يرجى الاشتراك بالقناه اولا \n 𖢵 اشترك هنا ['..database:get(bot_id..'add:ch:username')..']')
end
return false
end
if msg.can_be_deleted_ == false then 
send(msg.chat_id_, msg.id_,' 𖢵عذرا يرجى ترقيه البوت مشرف !')
return false  
end
tdcli_function ({ ID = "GetChannelFull", channel_id_ = getChatId(msg.chat_id_).ID }, function(arg,data)  
if tonumber(data.member_count_) < tonumber(database:get(bot_id..'Num:Add:Bot') or 0) and not DevSoFi(msg) then
send(msg.chat_id_, msg.id_,' 𖢵عدد اعضاء الجروب قليله يرجى جمع >> {'..(database:get(bot_id..'Num:Add:Bot') or 0)..'} عضو')
return false
end
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)
tdcli_function({ID ="GetChat",chat_id_=msg.chat_id_},function(arg,chat)  
if database:sismember(bot_id..'Chek:Groups',msg.chat_id_) then
send(msg.chat_id_, msg.id_,' 𖢵 الـجـروب مـفعـل مـن قبـل')
else
sendText(msg.chat_id_,'\n 𖢵 مـن قبـل ↭ ['..string.sub(result.first_name_,0, 70)..'](tg://user?id='..result.id_..')\n 𖢵تـم تـشغـيل الـبوت فـي الـجـروب  {'..chat.title_..'}\n  وتم تــرقــيه جــمــيع الـادمــنــيه',msg.id_/2097152/0.5,'md')
...
Text = ' 𖢵 تـم تـشغـيل الـبوت فـي الـجـروب جـديد\n'..
'\n 𖢵بواسطة {「'..Name..'」}'..
'\n 𖢵ايدي الجروب {'..IdChat..'}'..
'\n 𖢵اسم الجروب {['..NameChat..']}'..
'\n 𖢵عدد اعضاء الجروب *{'..NumMember..'}*'..
'\n 𖢵الرابط {['..LinkGp..']}'
if not DevSoFi(msg) then
sendText(SUDO,Text,0,'md')
end
...
send(msg.chat_id_, msg.id_,' 𖢵 الـبوت مـعطـل مـن قبـل')
else
sendText(msg.chat_id_,'\n 𖢵 مـن قبـل ↭ ['..string.sub(result.first_name_,0, 70)..'](tg://user?id='..result.id_..')\n 𖢵 تـم تـعـطيل الـبوت   {'..chat.title_..'}',msg.id_/2097152/0.5,'md')
database:srem(bot_id..'Chek:Groups',msg.chat_id_)  
local Name = '['..result.first_name_..'](tg://user?id='..result.id_..')'
local NameChat = chat.title_
local IdChat = msg.chat_id_
...
Text = '\n تـم تـعـطيل الـبوت مـن الـجـروب 𖢵'..
'\n 𖢵بواسطة {「'..Name..'」}'..
'\n 𖢵ايدي الجروب {'..IdChat..'}'..
'\n 𖢵اسم الجروب {['..NameChat..']}'..
'\n 𖢵الرابط {['..LinkGp..']}'
...
if database:sismember(bot_id..'Chek:Groups',msg.chat_id_) then
send(msg.chat_id_, msg.id_,' 𖢵تـم تـشغـيل الـبوت فـي الـجـروب ')
else
sendText(msg.chat_id_,'\n 𖢵 مـن قبـل ↭ ['..string.sub(result.first_name_,0, 70)..'](tg://user?id='..result.id_..')\n 𖢵تـم تـشغـيل الـبوت فـي الـجـروب  {'..chat.title_..'}\n  وتم تــرقــيه جــمــيع الـادمــنــيه',msg.id_/2097152/0.5,'md')
database:sadd(bot_id..'Chek:Groups',msg.chat_id_)  
...
send(msg.chat_id_, msg.id_,' 𖢵 تم تعيين عدد الاعضاء سيتم تفعيل الجروبات التي اعضائها اكثر من  >> {'..Num..'} عضو')
end
...
send(msg.chat_id_, msg.id_, ' 𖢵 حسنآ ارسل لي معرف القناة')
return false  
end
if text and text:match("^تغير رساله الاشتراك$") and DevSoFi(msg) then  
database:setex(bot_id.."textch:user" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' 𖢵 حسنآ ارسل لي النص الذي تريده')
return false  
end
if text == "مسح رساله الاشتراك " and DevSoFi(msg) then  
database:del(bot_id..'text:ch:user')
send(msg.chat_id_, msg.id_, " 𖢵 تم مسح رساله الاشتراك ")
return false  
end
if text and text:match("^وضع قناة الاشتراك 𖢵$") and DevSoFi(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' 𖢵 حسنآ ارسل لي معرف القناة')
return false  
end
...
send(msg.chat_id_, msg.id_," 𖢵 الاشتراك الاجباري مفعل \n 𖢵 على القناة  ↚ ["..addchusername.."]")
else
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_," 𖢵 اهلا عزيزي المطور \n 𖢵 ارسل الان معرف قناتك")
end
return false  
end
...
send(msg.chat_id_, msg.id_, " 𖢵 تم تعطيل الاشتراك الاجباري ")
return false  
end
if text == "الاشتراك الاجباري " and DevSoFi(msg) then  
if database:get(bot_id..'add:ch:username') then
local addchusername = database:get(bot_id..'add:ch:username')
send(msg.chat_id_, msg.id_, " 𖢵 تم تفعيل الاشتراك الاجباري \n 𖢵 على القناة  ↚ ["..addchusername.."]")
else
send(msg.chat_id_, msg.id_, " 𖢵 لا يوجد قناة في الاشتراك الاجباري ")
end
return false  
end
if text == "++-+++" and SudoBot(msg) then
send(msg.chat_id_, msg.id_, ' 𖢵 تم تفعيل الالعاب')
database:set(bot_id.."AL:AddS0FI:stats","✔")
end
if text == "+-+-+-+-+&--" and SudoBot(msg) then
send(msg.chat_id_, msg.id_, ' 𖢵 تم تعطيل الالعاب')
database:set(bot_id.."AL:AddS0FI:stats","✖")
end
...
send(msg.chat_id_, msg.id_, ' 𖢵 تم كتم الاسم '..BlNe)
...
send(msg.chat_id_, msg.id_, ' 𖢵 تم الغاء كتم الاسم '..delBn)
...
texts = " 𖢵 تم مسح الاسماء المكتومه "
send(msg.chat_id_, msg.id_, texts)
end
...
t = "\n 𖢵 قائمة الاسماء المكتومه \n𖣐━━━━━𖣐𝐒𝐀𝐈𝐃𝐈𖣐━━━━━𖣐 \n"
for k,v in pairs(All_name) do
t = t..""..k.."- (["..v.."])\n"
end
if #All_name == 0 then
t = " 𖢵 لا يوجد اسماء مكتومه"
end
send(msg.chat_id_, msg.id_, t)
end
end
if text == "تفعيل كتم الاسم" and Constructor(msg) and database:get(bot_id.."AL:AddS0FI:stats") == "✔" then
send(msg.chat_id_, msg.id_, ' 𖢵 تم التفعيل الاسماء المكتومه')
...
send(msg.chat_id_, msg.id_, ' 𖢵 تم تعطيل الاسماء المكتومه')
...
send(msg.chat_id_, msg.id_,' 𖢵 تم تعيين '..teh..' كتوحيد للمجموعه')
...
send(msg.chat_id_, msg.id_,' 𖢵 تم تعين  '..nump..' عدد الكتم')
...
send(msg.chat_id_, msg.id_, ' 𖢵 تم تعطيل التوحيد')
...
send(msg.chat_id_, msg.id_, " 𖢵 عزيزي >>["..mrsofi2.username_.."](https://t.me/"..(mrsofi2.username_ or "Soon_ban")..")\n 𖢵 عليك وضع التوحيد ⪼ {"..database:get(bot_id.."BANDA:teh"..msg.chat_id_).."} بجانب اسمك\n 𖢵 عدد المحاولات المتبقيه {"..(tonumber(mrsofi_nnn) - tonumber(mrsofi_nnn2)).."}")
end
end
end
end
...
local Text = [[
╔━━━━━━━━ 𝗦𝗔𝗜𝗗𝗜 𖢜 ━━━━━━━╗  
┇⦑[ᴡᴇʟᴄᴏᴍᴇ ᴛᴏ ѕᴏụʀᴄᴇ ѕᴀɪᴅɪ](t.me/Sadauam)⦒
┇⦑[ᴛʜᴇ ʙᴇѕᴛ ѕᴏụʀᴄᴇ ɪɴ ᴛᴇʟᴇ](t.me/Sadauam)⦒
┇⦑[ᴠᴇʀʏ ᴘʀᴏᴛᴇᴄᴛᴇᴅ ѕᴏụʀᴄᴇ ѕᴀɪᴅɪ](t.me/Sadauam)⦒
╚━━━━━━━━ 𝗦𝗔𝗜𝗗𝗜 𖢜 ━━━━━━━╝ 
]]
keyboard = {} 
keyboard.inline_keyboard = {
...
if text == 'اوسكار التونز' or text == 'Banda' or text == 'banda' then
local Text = [[
المبرمج اوسكار التونز لو حابب تتواصل معاه
اتبع الزر إلى تحت ↓
...
"قد جربت تبكي فرح؟ وليش؟ ",
  ...
  "هل انت حرامي تويت بتعت اوسكار التونز؟ ",
...
"‏ علينا إحياء زَمن الرّسائل الورقيّة وسط هذه الفوضى الالكترونية العَارمة. 𖢵💜",
...
"‏ من مراتب التعاسه إطالة الندم ع شيء إنتهى. 𖢵 ",
...
local iduser = userid 
send(msg.chat_id_, msg.id_,'  𖢵الايدي ↚ 「'..iduser..'」\n 𖢵المعرف ↚ 「'..username..'」\n 𖢵الرتبه ↚ 「'..rtp..'」\n 𖢵نوع الكشف ↚ بالمعرف') 
end,nil) 
else 
send(msg.chat_id_, msg.id_,'  𖢵المعرف غير صحيح') 
end 
end 
tdcli_function ({ID = "SearchPublicChat",username_ = username}, start_function, nil) 
end
...
if text == '𖣐━━━━━𖣐𝐒𝐀𝐈𝐃𝐈𖣐━━━━━𖣐' then
local Text = [[ 
 𖢵من أحسن السورسات على التليجرام سورس الصعيدي 𖢵
بجد سورس أمان جدا وفي مميزات جامده
تع نصب بوتك عندنا لو محظور
خش على تواصل هيدخلك لروم التواصل 
]]
...
local Text = [[  
 𖢵 اهلا في قائمه الالعاب المتطوره سورس الصعيدي 𖢵 
...
send(msg.chat_id_, msg.id_, '\n 𖢵 عذرا لا تستطيع حظر ( '..Rutba(result.sender_user_id_,msg.chat_id_)..' )')
end
...
send(msg.chat_id_, msg.id_,' 𖢵 تم ازالة جميع الاوامر المضافه')  
end
end
...
send(msg.chat_id_, msg.id_,' 𖢵 لا تستطيع استخدام البوت يرجى الاشتراك في القناة حتى تتمكن من استخدام الاوامر \n ??| اشترك هنا ['..database:get(bot_id..'add:ch:username')..']')
end
return false
end
database:set(bot_id.."Set:Cmd:Group"..msg.chat_id_..':'..msg.sender_user_id_,'true') 
send(msg.chat_id_, msg.id_,' 𖢵 ارسل الامر القديم')  
return false
end
...
send(msg.chat_id_, msg.id_,' 𖢵 ارسل الامر الذي قمت بوضعه بدلا عن القديم')  
return false
end
end
if text and database:get(bot_id.."Set:Cmd:Group"..msg.chat_id_..':'..msg.sender_user_id_) == 'true' then
database:set(bot_id.."Set:Cmd:Group:New"..msg.chat_id_,text)
send(msg.chat_id_, msg.id_,' 𖢵 ارسل الامر الجديد')  
...
send(msg.chat_id_, msg.id_,' 𖢵 تم حفظ الامر')  
...
send(msg.chat_id_, msg.id_, '𖢵  مـن قبـل  ↚ [「'..Rutba(msg.sender_user_id_,msg.chat_id_)..'」](T.ME/'..(data.username_ or 'textchuser')..') \n𖢵 تم تفعيل التنظيف التلقائي* ')
return false
end
if text == "تعطيل تنظيف التلقائي" and BasicConstructor(msg) then
database:del(bot_id.."LoMsg"..msg.chat_id_)
send(msg.chat_id_, msg.id_, '𖢵  مـن قبـل  ↚ [「'..Rutba(msg.sender_user_id_,msg.chat_id_)..'」](T.ME/'..(data.username_ or 'textchuser')..') \n𖢵 تم تعطيل التنظيف التلقائي* ')
return false
end
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' 𖢵 تم تعطيل جلب الصوره ،\n 𖢵 تم قفل البوتات  ،\n 𖢵 تم قفل التكرار ،\n 𖢵 تم قفل الروابط ،\n 𖢵 تم قفل التوجيه ،\n 𖢵 تم قفل الملصقات ،\n 𖢵 تم قفل المتحركه ،\n 𖢵 تم قفل الفيديو ،\n 𖢵 تم قفل الفشار ،\n 𖢵 تم قفل الانلاين ،\n 𖢵 تم قفل تعديل المديا ،\n 𖢵 تم وضع التكرار  ،\n 𖢵 تم قفل الفارسيه  ،\n 𖢵 تم وضع الايدي بدون صوره ،n  \n 𖢵 تم تفعيل الحمايه  بواسطه ، [「'..Rutba(msg.sender_user_id_,msg.chat_id_)..'」](T.ME/'..(data.username_ or 'textchuser')..')  ')
end,nil)   
end
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' 𖢵 تم تفعيل جلب الصوره ،\n 𖢵 تم  فتح البوتات  ،\n 𖢵 تم  فتح التكرار ،\n 𖢵 تم  فتح الروابط ،\n 𖢵 تم  فتح التوجيه ،\n 𖢵 تم  فتح الملصقات ،\n 𖢵 تم  فتح المتحركه ،\n 𖢵 تم  فتح الفيديو ،\n 𖢵 تم  فتح الفشار ،\n 𖢵 تم  فتح الانلاين ،\n 𖢵 تم  فتح تعديل المديا ،\n 𖢵 تم وضع التكرار  ،\n 𖢵 تم  فتح الفارسيه  ،\n 𖢵 تم وضع الايدي بصوره،n \n 𖢵 تم تفعيل الحمايه  بواسطه ، [「'..Rutba(msg.sender_user_id_,msg.chat_id_)..'」](T.ME/'..(data.username_ or 'textchuser')..')  ')
end,nil)   
end
...
Text = ' 𖢵 تم تفعيل امر غنيلي الان ارسل غنيلي'
database:del(bot_id..'sing:for:me'..msg.chat_id_)  
else
Text = ' 𖢵 بالتاكيد تم تفعيل امر غنيلي تستطيع ارسال غنيلي'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
Text = '\n 𖢵 تم تعطيل نسبه الانوثه'
else
Text = '\n 𖢵 بالتاكيد تم تعطيل نسبه الانوثه'
end
send(msg.chat_id_, msg.id_,Text) 
end
if text == 'تفعيل all' and CoSu(msg) then   
if database:get(bot_id..'Cick:all'..msg.chat_id_) then
Text = ' 𖢵 تم تفعيل امر @all'
database:del(bot_id..'Cick:all'..msg.chat_id_)  
else
Text = ' 𖢵 بالتاكيد تم تفعيل امر @all'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' 𖢵  مـن قبـل  ↚ [「'..Rutba(msg.sender_user_id_,msg.chat_id_)..'」](T.ME/'..(data.username_ or 'textchuser')..') \n 𖢵 تـم قفـل التاك بالتقييد ')
end,nil)   
elseif text == 'قفل التاك بالكتم' and Mod(msg) and msg.reply_to_message_id_ == 0 then 
database:set(bot_id.."lock:hashtak"..msg.chat_id_,'ktm')  
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' 𖢵  مـن قبـل  ↚ ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'textchuser')..') \n 𖢵 تـم قفـل التاك بالكتم ')
end,nil)   
elseif text == 'قفل التاك بالطرد' and Mod(msg) and msg.reply_to_message_id_ == 0 then 
database:set(bot_id.."lock:hashtak"..msg.chat_id_,'kick')  
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' 𖢵  مـن قبـل  ↚ [「'..Rutba(msg.sender_user_id_,msg.chat_id_)..'」](T.ME/'..(data.username_ or 'textchuser')..') \n 𖢵 تـم قفـل التاك بالطرد ')
end,nil)   
...
send(msg.chat_id_, msg.id_, " 𖢵 لا يمكنك حظر المطور الاساسي \n")
return false 
end
if tonumber(result.sender_user_id_) == tonumber(bot_id) then  
send(msg.chat_id_, msg.id_, " 𖢵 لا تسطيع حظر البوت عام")
return false 
end
if tonumber(result.sender_user_id_) == tonumber(1774315810) then  
send(msg.chat_id_, msg.id_, " 𖢵 لا تسطيع حظر مبرمج السورس عام")
return false 
end
...
if tonumber(result.sender_user_id_) == tonumber(1814229366) then  
send(msg.chat_id_, msg.id_, " 𖢵 لا تسطيع حظر مبرمج السورس عام")
return false 
end
...
function(arg,data) 
usertext = '\n 𖢵 الـعـضو   ↚ ['..data.first_name_..'](t.me/'..(data.username_ or 'Soon_ban')..')'
status  = '\n 𖢵 تم حظرو عام من الجروبات '
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
...
send(msg.chat_id_, msg.id_, " 𖢵 لا يمكنك حظر مبرمج السورس \n")
return false 
end
...
if result.id_ == tonumber(1814229366) then
send(msg.chat_id_, msg.id_, " ?? لا يمكنك حظر مبرمج السورس \n")
return false 
end
usertext = '\n 𖢵 الـعـضو   ↚ ['..result.title_..'](t.me/'..(username or 'Soon_ban')..')'
status  = '\n 𖢵 تم حظرو عام من الجروبات '
texts = usertext..status
...
if tonumber(userid) == tonumber(1814229366) then  
send(msg.chat_id_, msg.id_, " 𖢵 لا تسطيع حظر مبرمج السورس عام")
return false 
end
...
function start_function(extra, result, success)
if result.sender_user_id_ == tonumber(SUDO) then
send(msg.chat_id_, msg.id_, " 𖢵 لا يمكنك كتم المطور الاساسي \n")
return false 
end
if tonumber(result.sender_user_id_) == tonumber(bot_id) then  
send(msg.chat_id_, msg.id_, " 𖢵 لا تسطيع كتم البوت عام")
return false 
end
if tonumber(result.sender_user_id_) == tonumber(1774315810) then  
send(msg.chat_id_, msg.id_, " 𖢵 لا تسطيع كتم مبرمج السورس عام")
return false 
end
if tonumber(result.sender_user_id_) == tonumber(1757895188) then  
send(msg.chat_id_, msg.id_, " 𖢵 لا تسطيع كتم مبرمج السورس عام")
...
if result.id_ == tonumber(1774315810) then
send(msg.chat_id_, msg.id_, " 𖢵 لا يمكنك كتم مبرمج السورس \n")
return false 
end
if result.id_ == tonumber(1757895188) then
send(msg.chat_id_, msg.id_, " 𖢵 لا يمكنك كتم مبرمج السورس \n")
...
usertext = '\n 𖢵 الـعـضو   ↚ ['..data.first_name_..'](t.me/'..(data.username_ or 'Soon_ban')..')'
status  = '\n 𖢵 تم الغاء (الحظر-الكتم) عام من الجروبات'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
...
send(msg.chat_id_, msg.id_, "\n 𖢵 تم مسح قائمة المطورين  ")
end
if text == ("المطورين") and DevSoFi(msg) then
local list = database:smembers(bot_id..'Sudo:User')
t = "\n 𖢵  قائمة مطورين البوت \n𖣐━━━━━𖣐𝐒𝐀𝐈𝐃𝐈𖣐━━━━━𖣐\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
t = t..""..k.."- ([@"..username.."])\n"
...
if Get_info then
local TextS = "\n 𖢵 اهلا بك في متجر ملفات الصعيدي\n 𖢵 ملفات السورس ↓\n◤━───━??𝗼𝗼𝗼𝗻━───━◥\n\n"
local TextE = "\n𖣐━━━━━𖣐𝐒𝐀𝐈𝐃𝐈𖣐━━━━━𖣐\n 𖢵 علامة تعني { ✔️ } ملف مفعل\n 𖢵 علامة تعني { ✖ } ملف معطل\n 𖢵 قناة سورس الصعيدي↓\n".." 𖢵 [اضغط هنا لدخول](t.me/Sadauam) \n"
local NumFile = 0
...
send(msg.chat_id_, msg.id_," 𖢵 لا يوجد اتصال من ال api \n") 
end
return false
end
end
...
t = " 𖢵 بالتاكيد تم تعطيل ملف → "..file.."\n"
end
...
send(msg.chat_id_, msg.id_," 𖢵 عذرا الملف لايدعم سورس الصعيدي\n") 
end
return false
end
...
if file_bot then
io.close(file_bot)
t = " 𖢵 بالتاكيد تم تفعيل ملف → "..file.." \n"
else
t = " 𖢵 الملف  ↚ "..file.."\n 𖢵 تم تفعيل ملف \n"
end
local json_file, res = https.request("https://raw.githubusercontent.com/Ffasit/photo/main/File_Bot/"..file)
...
send(msg.chat_id_,msg.id_," 𖢵 تم مسح الملفات")
return false
end
...
send(msg.chat_id_, msg.id_,' 𖢵 لا ����ستطيع استخدام البوت \n 𖢵  يرجى الاشتراك بالقناه اولا \n 𖢵  اشترك هنا ['..database:get(bot_id..'add:ch:username')..']')
end
return false
end
function start_function(extra, result, success)
...
if #list == 0 then
t = " 𖢵 لا يوجد احد في قائمه الصعيدي"
end
send(msg.chat_id_, msg.id_, t)
return false
end
...
if #list == 0 then
t = " 𖢵 لا يوجد احد في قائمه المالك"
end
send(msg.chat_id_, msg.id_, t)
end
...
t = " 𖢵 المنشئين الاساسين تعالو مخرب \n𖣐━━━━━𖣐𝐒𝐀𝐈𝐃𝐈𖣐━━━━━𖣐\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
t = t..""..k.."- ([@"..username.."])\n"
...
if #list == 0 then
t = " 𖢵 ماكو منششئين يشوفولك جاره"
end
Reply_Status(msg,msg.sender_user_id_,"reply"," 𖢵 قام بنشر ملصق اباحيه\n"..t)  
...
Reply_Status(msg,msg.sender_user_id_,"reply"," 𖢵 قام بنشر صوره اباحيه\n"..t)  
DeleteMessage(msg.chat_id_,{[0] = tonumber(msg.id_),msg.id_})   
end   
end
...
Text = ' 𖢵 بالتاكيد تم تفعيل امر تحويل'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
Text = '\n 𖢵 تم تعطيل امر تحويل'
else
Text = '\n 𖢵 بالتاكيد تم تعطيل امر تحويل'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
send(msg.chat_id_, msg.id_, '\n 𖢵 تم مسح المنشئين الاساسين')
return false
end
if text == 'المنشئين الاساسين' and CoSu(msg) then
local list = database:smembers(bot_id..'Basic:Constructor'..msg.chat_id_)
t = "\n 𖢵 قائمة المنشئين الاساسين \n𖣐━━━━━𖣐𝐒𝐀𝐈𝐃𝐈𖣐━━━━━𖣐\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
t = t..""..k.."- ([@"..username.."])\n"
...
if b.first_name_ == false then
send(msg.chat_id_, msg.id_," 𖢵 حساب المنشئ محذوف")
return false  
end
local UserName = (b.username_ or "SRC-BANDA")
send(msg.chat_id_, msg.id_," 𖢵 منشئ الجروب  ↚ ["..b.first_name_.."](T.me/"..UserName..")")  
end,nil)   
end
end
end,nil)   
...
Reply_Status(msg,result.sender_user_id_,"reply","𖢵 تم ترقيته مطور ثانوي في البوت")  
end
...
Reply_Status(msg,result.id_,"reply","𖢵 تم ترقيته مطور ثانوي في البوت")  
else
send(msg.chat_id_, msg.id_,"𖢵 لا يوجد حساب بهاذا المعرف")
end
end
...
Reply_Status(msg,userid,"reply","𖢵 تم ترقيته مطور ثانوي في البوت")  
return false 
end
...
Reply_Status(msg,result.sender_user_id_,"reply","𖢵 تم تنزيله من المطور ثانويين")  
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_BANDA, nil)
return false 
end
...
Reply_Status(msg,result.id_,"reply","𖢵 تم تنزيله من المطور ثانويين")  
else
send(msg.chat_id_, msg.id_,"𖢵 لا يوجد حساب بهاذا المعرف")
end
end
...
Reply_Status(msg,userid,"reply","𖢵 تم تنزيله من المطور ثانويين")  
return false 
end
if text == ("الثانوين") and SudoBot(msg) then
local list = database:smembers(bot_id.."Dev:SoFi:2")
...
send(msg.chat_id_, msg.id_, "\n 𖢵 تم مسح قائمة المطورين الثانوين  ")
end
------------------------------------------------------------------------
...
if num2 == 0 then
send(msg.chat_id_, msg.id_," 𖢵 لا يوجد ادمنيه ليتم رفعهم") 
else
send(msg.chat_id_, msg.id_," 𖢵 تمت ترقيه { "..num2.." } من الادمنيه") 
end
end,nil)   
end
if text == 'مسح الادمنيه' and Manager(msg) then
database:del(bot_id..'Mod:User'..msg.chat_id_)
send(msg.chat_id_, msg.id_, ' 𖢵 تم مسح الادمنيه')
end
...
send(msg.chat_id_, msg.id_,' 𖢵 تم تعطيل الرفع') 
return false
end
...
send(msg.chat_id_, msg.id_, ' 𖢵 تم مسح المنظفين')
end
...
send(msg.chat_id_, msg.id_,' 𖢵 تم تعطيل الطرد') 
return false
end
function start_function(extra, result, success)
if tonumber(result.sender_user_id_) == tonumber(bot_id) then  
send(msg.chat_id_, msg.id_, " 𖢵 لا تسطيع طرد البوت ")
return false 
end
if Can_or_NotCan(result.sender_user_id_, msg.chat_id_) == true then
send(msg.chat_id_, msg.id_, '\n 𖢵 عذرا لا تستطيع طرد ( '..Rutba(result.sender_user_id_,msg.chat_id_)..' )')
else
tdcli_function ({ ID = "ChangeChatMemberStatus", chat_id_ = msg.chat_id_, user_id_ = result.id_, status_ = { ID = "ChatMemberStatusKicked" },},function(arg,data) 
if (data and data.code_ and data.code_ == 400 and data.message_ == "CHAT_ADMIN_REQUIRED") then 
send(msg.chat_id_, msg.id_,' 𖢵  ليس لدي صلاحية حظر المستخدمين يرجى تفعيلها !') 
return false  
end
if msg.can_be_deleted_ == false then 
send(msg.chat_id_, msg.id_,' 𖢵 البوت ليس ادمن يرجى ترقيتي !') 
return false  
end
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 𖢵 الـعـضو   ↚ ['..data.first_name_..'](t.me/'..(data.username_ or 'textchuser')..')'
...
send(msg.chat_id_, msg.id_, '\n 𖢵 عذرا لا تستطيع طرد ( '..Rutba(result.id_,msg.chat_id_)..' )')
else
tdcli_function ({ ID = "ChangeChatMemberStatus", chat_id_ = msg.chat_id_, user_id_ = result.id_, status_ = { ID = "ChatMemberStatusKicked" },},function(arg,data) 
if (result and result.type_ and result.type_.ID == "ChannelChatInfo") then
send(msg.chat_id_,msg.id_,"⚠| عذرا عزيزي المستخدم هاذا معرف قناة يرجى استخدام الامر بصوره صحيحه !")   
...
send(msg.chat_id_, msg.id_, '\n 𖢵 عذرا لا تستطيع طرد ( '..Rutba(userid,msg.chat_id_)..' )')
else
...
send(msg.chat_id_, msg.id_, ' 𖢵 تم مسح المميزين')
end
if text == ("المميزين") and Mod(msg) then
local list = database:smembers(bot_id..'Special:User'..msg.chat_id_)
t = "\n 𖢵 قائمة مميزين الجروب \n𖣐━━━━━𖣐𝐒𝐀𝐈𝐃𝐈𖣐━━━━━𖣐\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
t = t..""..k.."- ([@"..username.."])\n"
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n 𖢵 لعضو  ↚ ['..data.first_name_..'](t.me/'..(data.username_ or 'textchuser')..')'
status  = '\n 𖢵 تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n 𖢵 الـعـضو   ↚ '..userid..''
...
------------------------------------------------------------------------
if text == 'مسح الاريالين' and Mod(msg) then
database:del(bot_id..'Mote:User'..msg.chat_id_)
send(msg.chat_id_, msg.id_, ' 𖢵 تم مسح جميع الاريالين')
end
if text == ("تاك للاريالين") and Mod(msg) then
local list = database:smembers(bot_id..'Mote:User'..msg.chat_id_)
t = "\n 𖢵 قائمة اريالين الجروب \n⧬━┅┅┄⟞❲[??🅞🅞🅽](t.me/Sadauam)❳⟝┄┉┉━⧬\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
t = t..""..k.." ↚ الاريال [@"..username.."]\n"
else
t = t..""..k.." ↚ الاريال `"..v.."`\n"
end
end
...
---------
if text == ("رفع اريال") and tonumber(msg.reply_to_message_id_) ~= 0 and Mod(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 𖢵 الـعـضو   ↚ ['..data.first_name_..'](t.me/'..(data.username_ or 'DEVBESSO')..')'
local  statuss  = '\n 𖢵 تم رفع الـعـضو  اريال في الجروب \n'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
if (text == ("تنزيل اريال")) and msg.reply_to_message_id_ and Mod(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 𖢵 الـعـضو   ↚ ['..data.first_name_..'](t.me/'..(data.username_ or 'textchuser')..')'
status  = '\n 𖢵 تم تنزيل الـعـضو  اريال في الجروب\n'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
send(msg.chat_id_, msg.id_, ' 𖢵 تم مسح جميع الزوجات')
end
if text == ("تاك للزوجات") and Mod(msg) then
local list = database:smembers(bot_id..'Mode:User'..msg.chat_id_)
t = "\n 𖢵 قائمه زوجات الجروب \n 𖢵═───═❲[𝗦𝗔𝗜𝗗𝗜 𖢜 ](t.me/Sadauam)❳═───═??\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 𖢵 العضــو  ↚ ['..data.first_name_..'](t.me/'..(data.username_ or 'DEVBESSO')..')'
local  statuss  = '\n 𖢵 تم رفع العضــو زوجه في الجروب \n'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 𖢵 العضــو  ↚ ['..data.first_name_..'](t.me/'..(data.username_ or 'textchuser')..')'
status  = '\n 𖢵 تم تنزيل العضــو الزوجات من الجروب\n'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
send(msg.chat_id_, msg.id_, ' 𖢵 تم مسح جميع الكلاب')
end
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 𖢵 العضــو  ↚ ['..data.first_name_..'](t.me/'..(data.username_ or 'DEVBESSO')..')'
local  statuss  = '\n 𖢵 تم رفع العضــو كلب في الجروب \n'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 𖢵 العضــو  ↚ ['..data.first_name_..'](t.me/'..(data.username_ or 'textchuser')..')'
status  = '\n 𖢵 تم تنزيل العضــو كلب من الجروب\n'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
send(msg.chat_id_, msg.id_, ' 𖢵 تم تنزيل جميع حمير من الجروب')
end
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 𖢵 الـعـضو   ↚ ['..data.first_name_..'](t.me/'..(data.username_ or 'textchuser')..')'
local  statuss  = '\n 𖢵 تم رفع المتهم حمار بالجروب\n 𖢵 الان اصبح حمار الجروب'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
send(msg.chat_id_, msg.id_, ' 𖢵 تم تنزيل جميع وتكات الجروب')
end
if text == ("تاك للوتكات") and Mod(msg) then
local list = database:smembers(bot_id..'Motte:User'..msg.chat_id_)
t = "\n 𖢵 قائمة وتكات الجروب \n𖣐━━━━━𖣐𝐒𝐀𝐈𝐃𝐈𖣐━━━━━𖣐\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
-----------------------------------------------------
if text == 'مسح الشرموطهه' and Mod(msg) then
database:del(bot_id..'Motee:User'..msg.chat_id_)
send(msg.chat_id_, msg.id_, ' 𖢵 تم تنزيل جميع الشرموطهه بالجروب')
end
if text == ("تاك لشراميط") and Mod(msg) then
local list = database:smembers(bot_id..'Motee:User'..msg.chat_id_)
t = "\n 𖢵 قائمة القرود الجروب \n𖣐━━━━━𖣐𝐒𝐀𝐈𝐃𝐈𖣐━━━━━𖣐\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
---------
if text == ("رفع شرموطه") and tonumber(msg.reply_to_message_id_) ~= 0 and Mod(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 𖢵 الـعـضو   ↚ ['..data.first_name_..'](t.me/'..(data.username_ or 'textchuser')..')'
local  statuss  = '\n 𖢵 تم رفع شرموطه في الجروب\n 𖢵 تعال حبي استلم موزه'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
if (text == ("تنزيل شرموطه")) and msg.reply_to_message_id_ and Mod(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
send(msg.chat_id_, msg.id_, ' 𖢵 تم تنزيل جميع البقرات بالجروب')
end
if text == ("تاك للبقرات") and Mod(msg) then
local list = database:smembers(bot_id..'Bakra:User'..msg.chat_id_)
t = "\n 𖢵 قائمة البقرات الجروب \n𖣐━━━━━𖣐𝐒𝐀𝐈𝐃𝐈𖣐━━━━━𖣐\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 𖢵 الـعـضو   ↚ ['..data.first_name_..'](t.me/'..(data.username_ or 'textchuser')..')'
local  statuss  = '\n 𖢵 تم رفع بقره في الجروب\n 𖢵 ها يالهايشه تع احلبك'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 𖢵 الـعـضو   ↚ ['..data.first_name_..'](t.me/'..(data.username_ or 'textchuser')..')'
status  = '\n 𖢵 تم تنزيل بقره من الجروب\n 𖢵 تعال هاك حليب مالتك'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
send(msg.chat_id_, msg.id_, ' 𖢵 تم تنزيل جميع المزز بالجروب')
end
...
send(msg.chat_id_, msg.id_, ' 𖢵 تم تنزيل جميع االاكساس')
end
...
database:del(bot_id..'Zahf:User'..msg.chat_id_)
send(msg.chat_id_, msg.id_, ' 𖢵 تم تنزيل جميع القلوب ')
end
if text == ("تاك لقلبي") and Mod(msg) then
local list = database:smembers(bot_id..'Zahf:User'..msg.chat_id_)
t = "\n 𖢵 قائمة القلوب في الجروب\n𖣐━━━━━𖣐𝐒𝐀𝐈𝐃𝐈𖣐━━━━━𖣐\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
t = t..""..k.."← قلبي [@"..username.."]\n"
...
database:del(bot_id..'Zahf:User'..msg.chat_id_)
send(msg.chat_id_, msg.id_, ' 𖢵 تم تنزيل جميع أولادي')
end
...
database:del(bot_id..'Zahf:User'..msg.chat_id_)
send(msg.chat_id_, msg.id_, ' 𖢵 تم تنزيل جميع زواحف')
end
if text == ("تاك للرقاصات") and Mod(msg) then
local list = database:smembers(bot_id..'Zahf:User'..msg.chat_id_)
t = "\n 𖢵 قائمة رقاصات الجروب \n𖣐━━━━━𖣐𝐒𝐀𝐈𝐃𝐈𖣐━━━━━𖣐\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 𖢵 الـعـضو   ↚ ['..data.first_name_..'](t.me/'..(data.username_ or 'Soon_ban')..')'
local statuss = '\n 𖢵 تم رفع رقاصه في الجروب\n 𖢵 مبقتش شريفه لا اله الي الله'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 𖢵 الـعـضو   ↚ ['..data.first_name_..'](t.me/'..(data.username_ or 'Soon_ban')..')'
status = '\n 𖢵 تم تنزيل رقاصه من الجروب\n 𖢵 بقت شريفه لا اله الي الله'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
send(msg.chat_id_, msg.id_, ' 𖢵 تم تنزيل جميع جريزي')
end
if text == ("تاك للمتناكين") and Mod(msg) then
local list = database:smembers(bot_id..'Jred:User'..msg.chat_id_)
t = "\n 𖢵 قائمة المتناكين الجروب \n𖣐━━━━━𖣐𝐒𝐀𝐈𝐃𝐈𖣐━━━━━𖣐\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
t = t..""..k.." ↚ المتناك [@"..username.."]\n"
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 𖢵 الـعـضو   ↚ ['..data.first_name_..'](t.me/'..(data.username_ or 'Soon_ban')..')'
local statuss = '\n 𖢵 تم رفع الـعـضو  علي زبك بنجاح\n 𖢵 تفضل ابدا نيك'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
database:del(bot_id..'Zahf:User'..msg.chat_id_)
send(msg.chat_id_, msg.id_, ' 𖢵 تم مسح كل الحكاكين')
end
if text == ("تاك للحكاكين") and Mod(msg) then
local list = database:smembers(bot_id..'Zahf:User'..msg.chat_id_)
t = "\n 𖢵 قائمة حكاكين الجروب \n𖣐━━━━━𖣐𝐒𝐀𝐈𝐃𝐈𖣐━━━━━𖣐\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
database:sadd(bot_id..'Zahf:User'..msg.chat_id_, result.sender_user_id_)
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 𖢵 الـعـضو  ← ['..data.first_name_..'](t.me/'..(data.username_ or 's_o_op')..')'
local  statuss  = '\n 𖢵 تم رفع حكاك في الجروب\n 𖢵 احمرت ولا لسا'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 𖢵 الـعـضو  ← ['..data.first_name_..'](t.me/'..(data.username_ or 's_o_op')..')'
status  = '\n 𖢵 تم تنزيل حكاك من الجروب\n 𖢵 لا يسطت هيفضل حكاك رسمي'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
database:del(bot_id..'Girl:User'..msg.chat_id_)
send(msg.chat_id_, msg.id_, ' 𖢵 تم مسح كل النسوان بالجروب')
end
if text == ("تاك للنسوان") and Mod(msg) then
local list = database:smembers(bot_id..'Girl:User'..msg.chat_id_)
t = "\n 𖢵 قائمة نسوان الجروب \n𖣐━━━━━𖣐𝐒𝐀𝐈𝐃𝐈𖣐━━━━━𖣐\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 𖢵 الـعـضو  ← ['..data.first_name_..'](t.me/'..(data.username_ or 's_o_op')..')'
local  statuss  = '\n 𖢵 تم رفع مره في الجروب\n 𖢵 ها صرتي من نسواني تعي ندخل'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 𖢵 الـعـضو  ← ['..data.first_name_..'](t.me/'..(data.username_ or 's_o_op')..')'
status  = '\n 𖢵 تم تنزيل مره من الجروب\n 𖢵 بتاعي غضبان عليكي ليوم الدين'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
database:del(bot_id..'Mode:User'..msg.chat_id_)
send(msg.chat_id_, msg.id_, ' 𖢵 تم مسح جميع المتزوجين')
end
if text == ("تاك للمتزوجين") and Mod(msg) then
local list = database:smembers(bot_id..'Mode:User'..msg.chat_id_)
t = "\n 𖢵 قائمه ازواج الجروب \n𖣐━━━━━𖣐𝐒𝐀𝐈𝐃𝐈𖣐━━━━━𖣐\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 𖢵 العضــو ← ['..data.first_name_..'](t.me/'..(data.username_ or 'DEVBESSO')..')'
local  statuss  = '\n 𖢵 تم زواجكم بنجاح في الجروب \n 𖢵 الطلاق امتي عشان ابقي موجود '
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
database:srem(bot_id..'Mode:User'..msg.chat_id_, result.sender_user_id_)
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 𖢵 العضــو ← ['..data.first_name_..'](t.me/'..(data.username_ or 's_o_op')..')'
status  = '\n 𖢵 تم طلاقكم بنجاح في الجروب\n 𖢵 اوجعو تاني ونبي'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
if database:get(bot_id..'Lock:Add:Bot'..msg.chat_id_) and not Constructor(msg) then
send(msg.chat_id_, msg.id_,' 𖢵 تم تعطيل القتل') 
return false
end
function start_function(extra, result, success)
database:sadd(bot_id..'Zahf:User'..msg.chat_id_, result.sender_user_id_)
...
if database:get(bot_id..'Lock:kick'..msg.chat_id_) and not Constructor(msg) then
send(msg.chat_id_, msg.id_,' 𖢵 تم تعطيل الحظر') 
return false
end
function start_function(extra, result, success)
if tonumber(result.sender_user_id_) == tonumber(bot_id) then  
send(msg.chat_id_, msg.id_, " 𖢵 لا تسطيع حظر البوت ")
return false 
end
if Can_or_NotCan(result.sender_user_id_, msg.chat_id_) == true then
send(msg.chat_id_, msg.id_, '\n 𖢵 عذرا لا تستطيع حظر ( '..Rutba(result.sender_user_id_,msg.chat_id_)..' )')
...
if result.id_ then
if Can_or_NotCan(result.id_, msg.chat_id_) == true then
send(msg.chat_id_, msg.id_, '\n 𖢵 عذرا لا تستطيع حظر ( '..Rutba(result.id_,msg.chat_id_)..' )')
else
tdcli_function ({ ID = "ChangeChatMemberStatus", chat_id_ = msg.chat_id_, user_id_ = result.id_, status_ = { ID = "ChatMemberStatusKicked" },},function(arg,data) 
if (result and result.type_ and result.type_.ID == "ChannelChatInfo") then
send(msg.chat_id_,msg.id_," 𖢵 عذرا عزيزي المستخدم هاذا معرف قناة يرجى استخدام الامر بصوره صحيحه !")   
...
usertext = '\n 𖢵  المستخدم  ↚ ['..result.title_..'](t.me/'..(username or 'GLOBLA')..')'
status  = '\n 𖢵 تم حظره'
texts = usertext..status
chat_kick(msg.chat_id_, result.id_)
send(msg.chat_id_, msg.id_, texts)
...
if Can_or_NotCan(userid, msg.chat_id_) == true then
send(msg.chat_id_, msg.id_, '\n 𖢵 عذرا لا تستطيع حظر ( '..Rutba(userid,msg.chat_id_)..' )')
else
tdcli_function ({ ID = "ChangeChatMemberStatus", chat_id_ = msg.chat_id_, user_id_ = userid, status_ = { ID = "ChatMemberStatusKicked" },},function(arg,data) 
if (data and data.code_ and data.code_ == 400 and data.message_ == "CHAT_ADMIN_REQUIRED") then 
send(msg.chat_id_, msg.id_,' 𖢵 ليس لدي صلاحية حظر المستخدمين يرجى تفعيلها !') 
...
function start_function(extra, result, success)
if tonumber(result.sender_user_id_) == tonumber(bot_id) then
send(msg.chat_id_, msg.id_, ' 𖢵 انا لست محظورآ \n') 
return false 
end
...
send(msg.chat_id_, msg.id_, ' 𖢵 تم مسح المكتومين')
end
...
function start_function(extra, result, success)
if tonumber(result.sender_user_id_) == tonumber(bot_id) then  
send(msg.chat_id_, msg.id_, " 𖢵 لا تسطيع كتم البوت ")
return false 
end
if Can_or_NotCan(result.sender_user_id_, msg.chat_id_) == true then
send(msg.chat_id_, msg.id_, '\n 𖢵 عذرا لا تستطيع كتم ( '..Rutba(result.sender_user_id_,msg.chat_id_)..' )')
else
if msg.can_be_deleted_ == false then 
send(msg.chat_id_, msg.id_,' 𖢵 البوت ليس ادمن يرجى ترقيتي !') 
return false  
...
if Can_or_NotCan(result.id_, msg.chat_id_) == true then
send(msg.chat_id_, msg.id_, '\n 𖢵 عذرا لا تستطيع كتم ( '..Rutba(result.id_,msg.chat_id_)..' )')
else
if (result and result.type_ and result.type_.ID == "ChannelChatInfo") then
send(msg.chat_id_,msg.id_," 𖢵 عذرا عزيزي المستخدم هاذا معرف قناة يرجى استخدام الامر بصوره صحيحه !")   
return false 
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 𖢵 الـعـضو   ↚ ['..data.first_name_..'](t.me/'..(data.username_ or 'textchuser')..')'
status  = '\n 𖢵 تم كتم لمدة ~ { '..TextEnd[2]..' '..TextEnd[3]..'}'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
...
return send(msg.chat_id_, msg.id_,"𖢵 تم وضع وقت التنظيف:( `"..GetDo.." `) ساعه")
end
...
if Can_or_NotCan(userid, msg.chat_id_) == true then
send(msg.chat_id_, msg.id_, '\n 𖢵 عذرا لا تستطيع كتم ( '..Rutba(userid,msg.chat_id_)..' )')
else
if msg.can_be_deleted_ == false then 
send(msg.chat_id_, msg.id_,' 𖢵 البوت ليس ادمن يرجى ترقيتي !') 
return false  
...
function start_function(extra, result, success)
if tonumber(result.sender_user_id_) == tonumber(bot_id) then  
send(msg.chat_id_, msg.id_, " 𖢵 لا تسطيع تقيد البوت ")
return false 
end
if Can_or_NotCan(result.sender_user_id_, msg.chat_id_) then
send(msg.chat_id_, msg.id_, '\n 𖢵 عذرا لا تستطيع تقيد ( '..Rutba(result.sender_user_id_,msg.chat_id_)..' )')
else
...
if Can_or_NotCan(result.id_, msg.chat_id_) then
send(msg.chat_id_, msg.id_, '\n 𖢵 عذرا لا تستطيع تقيد ( '..Rutba(result.id_,msg.chat_id_)..' )')
return false 
end      
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 𖢵 الـعـضو   ↚ ['..data.first_name_..'](t.me/'..(data.username_ or 'textchuser')..')'
status  = '\n 𖢵 تم تقيده لمدة ~ { '..TextEnd[2]..' '..TextEnd[3]..'}'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
https.request("https://api.telegram.org/bot"..token.."/restrictChatMember?chat_id="..msg.chat_id_.."&user_id="..result.sender_user_id_..'&until_date='..tonumber(msg.date_+Time))
end
...
send(msg.chat_id_, msg.id_, '\n 𖢵 عذرا لا تستطيع تقيد ( '..Rutba(userid,msg.chat_id_)..' )')
else
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 𖢵  الـعـضو   ↚ ['..data.first_name_..'](t.me/'..(data.username_ or 'textchuser')..')'
status  = '\n 𖢵  الايدي  ↚ `'..result.sender_user_id_..'`\n 𖢵  تم رفعه مشرف '
send(msg.chat_id_, msg.id_, usertext..status)
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 𖢵  الـعـضو   ↚ ['..data.first_name_..'](t.me/'..(data.username_ or 'textchuser')..')'
status  = '\n 𖢵  الايدي  ↚ `'..result.sender_user_id_..'`\n 𖢵  تم تنزيله ادمن من الجروب بكل الصلاحيات'
send(msg.chat_id_, msg.id_, usertext..status)
https.request("https://api.telegram.org/bot"..token.."/promoteChatMember?chat_id=" .. msg.chat_id_ .. "&user_id=" ..result.sender_user_id_.."&can_change_info=false&can_delete_messages=false&can_invite_users=false&can_restrict_members=false&can_pin_messages=false&can_promote_members=false")
end,nil)
end
...
usertext = '\n 𖢵  الـعـضو   ↚ ['..result.title_..'](t.me/'..(username or 'textchuser')..')'
status  = '\n 𖢵  تم تنزيله مشرف من الجروب بكل الصلاحيات'
texts = usertext..status
send(msg.chat_id_, msg.id_, texts)
https.request("https://api.telegram.org/bot"..token.."/promoteChatMember?chat_id=" .. msg.chat_id_ .. "&user_id=" ..result.id_.."&can_change_info=false&can_delete_messages=false&can_invite_users=false&can_restrict_members=false&can_pin_messages=false&can_promote_members=false")
else
...
local text = 
'\n❲[𝗦𝗔𝗜𝗗𝗜 𖢜 ](t.me/Sadauam)❳'..
'\n𖣐━━━━━𖣐𝐒𝐀𝐈𝐃𝐈𖣐━━━━━𖣐'..
'\n 𖢵 اعدادات الجروب كتالي √↓'..
'\nء𖣐━━━━━𖣐𝐒𝐀𝐈𝐃𝐈𖣐━━━━━𖣐'..
'\n 𖢵  علامة ال {✓} تعني مفعل'..
'\n 𖢵  علامة ال {✘} تعني معطل'..
'\nء𖣐━━━━━𖣐𝐒𝐀𝐈𝐃𝐈𖣐━━━━━𖣐'..
'\n 𖢵  الروابط  ↚ { '..lock_links..
' }\n'..' 𖢵  المعرفات  ↚ { '..lock_user..
' }\n'..' 𖢵  التاك  ↚ { '..lock_hash..
' }\n'..' 𖢵  البوتات  ↚ { '..lock_bots..
' }\n'..' 𖢵  التوجيه  ↚ { '..lock_fwd..
' }\n'..' 𖢵  التثبيت  ↚ { '..lock_pin..
' }\n'..' 𖢵  الاشعارات  ↚ { '..lock_tagservr..
' }\n'..' 𖢵  الماركدون  ↚ { '..lock_mark..
' }\n'..' 𖢵  التعديل  ↚ { '..lock_edit..
' }\n'..' 𖢵  تعديل الميديا  ↚ { '..lock_edit_med..
' }\nء𖣐━━━━━𖣐𝐒𝐀𝐈𝐃𝐈𖣐━━━━━𖣐'..
'\n'..' 𖢵  الكلايش  ↚ { '..lock_spam..
' }\n'..' 𖢵  الكيبورد  ↚ { '..lock_inlin..
' }\n'..' 𖢵  الاغاني  ↚ { '..lock_vico..
' }\n'..' 𖢵  المتحركه  ↚ { '..lock_gif..
' }\n'..' 𖢵  الملفات  ↚ { '..lock_file..
' }\n'..' 𖢵  الدردشه  ↚ { '..lock_text..
...
' }\n'..' 𖢵  التكرار  ↚ { '..flood..
' }\n'..' 𖢵  الترحيب  ↚ { '..welcome..
' }\n'..' 𖢵  عدد التكرار  ↚ { '..NUM_MSG_MAX..
' }\nء𖣐━━━━━𖣐𝐒𝐀𝐈𝐃𝐈𖣐━━━━━𖣐'..
'\n 𖢵  علامة ال {✓} تعني مفعل'..
'\n 𖢵  علامة ال {✘} تعني معطل'..
'\nء𖣐━━━━━𖣐𝐒𝐀𝐈𝐃𝐈𖣐━━━━━𖣐'..
'\n'..' 𖢵  امر صيح  ↚ { '..kickme..
' }\n'..' 𖢵  امر اطردني  ↚ { '..sehuser..
' }\n'..' 𖢵  امر منو ضافني  ↚ { '..addme..
' }\n'..' 𖢵  الردود  ↚ { '..rdmder..
' }\n'..' 𖢵  الردود العامه  ↚ { '..rdsudo..
' }\n'..' 𖢵  الايدي  ↚ { '..idgp..
' }\n'..' 𖢵  الايدي بالصوره  ↚ { '..idph..
' }\n'..' 𖢵  الرفع  ↚ { '..setadd..
' }\n'..' 𖢵  الحظر  ↚ { '..banm..' }\n\n 𖢵𖣐━━━━━𖣐𝐒𝐀𝐈𝐃𝐈𖣐━━━━━𖣐\n 𖢵 قناة سورس الصعيدي↓\n [ ❲[𝐒ΘΘ𝐍](t.me/Sadauam)❳](t.me/Sadauam) \n'
send(msg.chat_id_, msg.id_,text)     
end
...
send(msg.chat_id_,msg.id_," 𖢵 عذرآ تم قفل التثبيت")  
return false  
end
tdcli_function ({ID = "PinChannelMessage",channel_id_ = msg.chat_id_:gsub('-100',''),message_id_ = msg.reply_to_message_id_,disable_notification_ = 1},function(arg,data) 
if data.ID == "Ok" then
send(msg.chat_id_, msg.id_," 𖢵 تم تثبيت الرساله")   
database:set(bot_id..'Pin:Id:Msg'..msg.chat_id_,msg.reply_to_message_id_)
elseif data.code_ == 6 then
send(msg.chat_id_,msg.id_," 𖢵 انا لست ادمن هنا يرجى ترقيتي ادمن ثم اعد المحاوله")  
elseif data.message_ == "CHAT_NOT_MODIFIED" then
send(msg.chat_id_,msg.id_," 𖢵 لا توجد رساله مثبته")  
elseif data.message_ == "CHAT_ADMIN_REQUIRED" then
send(msg.chat_id_,msg.id_," 𖢵 ليست لدي صلاحية التثبيت يرجى التحقق من الصلاحيات")  
end
end,nil) 
end
...
if database:sismember(bot_id..'lock:pin',msg.chat_id_) and not Constructor(msg) then
send(msg.chat_id_,msg.id_," 𖢵 عذرآ تم قفل الثبيت")  
return false  
end
tdcli_function({ID="UnpinChannelMessage",channel_id_ = msg.chat_id_:gsub('-100','')},function(arg,data) 
if data.ID == "Ok" then
send(msg.chat_id_, msg.id_," 𖢵 تم الغاء تثبيت الرساله")   
...
tdcli_function({ID="UnpinChannelMessage",channel_id_ = msg.chat_id_:gsub('-100','')},function(arg,data) 
if data.ID == "Ok" then
send(msg.chat_id_, msg.id_," 𖢵 تم الغاء تثبيت الكل")   
...
send(msg.chat_id_, msg.id_, t..'𖣐━━━━━𖣐𝐒𝐀𝐈𝐃𝐈𖣐━━━━━𖣐\nاضغط علي الاسم ليتم نسخه\n𖣐━━━━━𖣐𝐒𝐀𝐈𝐃𝐈𖣐━━━━━𖣐ٴ\n 𖢵 ❲[𝗦𝗔𝗜𝗗𝗜 𖢜 ](t.me/Sadauam)❳ 𖢵 ')
end
...
send(msg.chat_id_,msg.id_," 𖢵 حسنآ ارسل اليه الرابط الان")
...
if Constructor(msg) then  
database:set(bot_id.."my_photo:status"..msg.chat_id_,true) 
send(msg.chat_id_, msg.id_," 𖢵 تم تفعيل الصوره") 
return false  
end
end
...
if Constructor(msg) then  
database:del(bot_id.."my_photo:status"..msg.chat_id_) 
send(msg.chat_id_, msg.id_," 𖢵 تم تعطيل الصوره") 
return false end
end
if text == "تفعيل نسبه جمالي" or text == 'تفعيل جمالي' then
if Constructor(msg) then  
database:set(bot_id.."pp_photo:status"..msg.chat_id_,true) 
send(msg.chat_id_, msg.id_," 𖢵 تم تفعيل نسبه جمالك") 
return false  
end
end
...
if Constructor(msg) then  
database:del(bot_id.."pp_photo:status"..msg.chat_id_) 
send(msg.chat_id_, msg.id_," 𖢵 تم تعطيل نسبه جمالك") 
return false end
end
if text == "الرابط" then 
...
send(msg.chat_id_,msg.id_," 𖢵 تم مسح الرابط")           
...
send(msg.chat_id_, msg.id_,' 𖢵 ارسل لي الصوره') 
return false
end
...
send(msg.chat_id_, msg.id_,' 𖢵 تم ازالة صورة الجروب') 
end
return false  
end
...
send(msg.chat_id_, msg.id_,' 𖢵 ارسل الان الوصف')
end
return false  
end
...
t  = ' 𖢵 ارسل لي الترحيب الان'
tt = '\n 𖢵 تستطيع اضافة مايلي !\n 𖢵 دالة عرض الاسم  ↚{`name`}\n 𖢵 دالة عرض المعرف  ↚{`user`}'
...
GetWelcome = ' 𖢵 لم يتم تعيين ترحيب للكروب'
end 
...
send(msg.chat_id_, msg.id_,' 𖢵 تم تفعيل ترحيب الجروب') 
return false  
end
...
send(msg.chat_id_, msg.id_,' 𖢵 تم تعطيل ترحيب الجروب') 
return false  
end
if text == 'مسح الترحيب' or text == 'مسح الترحيب' then 
if Mod(msg) then
database:del(bot_id..'Get:Welcome:Group'..msg.chat_id_) 
send(msg.chat_id_, msg.id_,' 𖢵 تم ازالة ترحيب الجروب') 
end
end
if text and text == "منع" and msg.reply_to_message_id_ == 0 and Manager(msg)  then       
send(msg.chat_id_, msg.id_," 𖢵 ارسل الكلمه لمنعها")  
...
if tsssst == "rep" then   
send(msg.chat_id_, msg.id_," 𖢵 ارسل التحذير عند ارسال الكلمه")  
...
if test == "repp" then  
send(msg.chat_id_, msg.id_," 𖢵 تم منع الكلمه مع التحذير")  
...
send(msg.chat_id_, msg.id_," 𖢵 ارسل الكلمه الان")  
database:set(bot_id.."BANDA1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"reppp")  
return false  end
if text then 
local test = database:get(bot_id.."BANDA1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if test and test == "reppp" then   
send(msg.chat_id_, msg.id_," 𖢵 تم الغاء منعها")  
database:del(bot_id.."BANDA1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
...
send(msg.chat_id_, msg.id_," 𖢵 تم مسح قائمه المنع")  
end
...
send(msg.chat_id_,msg.id_,' 𖢵 تم الغاء حفظ كليشة المطور')
return false
end
database:set(bot_id..'TEXT_SUDO',text)
database:del(bot_id..'Set:TEXT_SUDO'..msg.chat_id_..':'..msg.sender_user_id_)
send(msg.chat_id_,msg.id_,' 𖢵 تم حفظ كليشة المطور')
return false
end
-----------------
...
send(msg.chat_id_, msg.id_, ' 𖢵 تم ازالة كليشة الايدي')
end
return false  
end 
...
if text == 'الغاء' then 
send(msg.chat_id_, msg.id_," 𖢵 تم الغاء تعين الايدي") 
...
send(msg.chat_id_, msg.id_,' 𖢵 تم تعين الايدي')    
end
...
if (c - x) == 0 then
send(msg.chat_id_, msg.id_, " 𖢵 لا توجد بوتات في الجروب")
else
local t = ' 𖢵 عدد البوتات هنا >> {'..c..'}\n 𖢵 عدد البوتات التي هي ادمن >> {'..x..'}\n 𖢵 تم طرد >> {'..(c - x)..'} من البوتات'
send(msg.chat_id_, msg.id_,t) 
end 
end,nil)  
end   
...
if #admins == i then 
local a = '\n𖣐━━━━━𖣐𝐒𝐀𝐈𝐃𝐈𖣐━━━━━𖣐\n 𖢵 عدد البوتات التي هنا >> {'..n..'} بوت\n'
local f = ' 𖢵 عدد البوتات التي هي ادمن >> {'..t..'}\n 𖢵 ملاحضه علامة ال ( 𖢵) تعني ان البوت ادمن \n'
...
if text == 'الغاء' then 
send(msg.chat_id_, msg.id_, " 𖢵 تم الغاء حفظ القوانين") 
database:del(bot_id.."Set:Rules:" .. msg.chat_id_ .. ":" .. msg.sender_user_id_)
return false  
end 
database:set(bot_id.."Set:Rules:Group" .. msg.chat_id_,text) 
send(msg.chat_id_, msg.id_," 𖢵 تم حفظ قوانين الجروب") 
database:del(bot_id.."Set:Rules:" .. msg.chat_id_ .. ":" .. msg.sender_user_id_)
end  
...
send(msg.chat_id_,msg.id_," 𖢵 ارسل لي القوانين الان")  
end
end
if text == 'مسح القوانين' or text == 'مسح القوانين' then  
if Mod(msg) then
send(msg.chat_id_, msg.id_," 𖢵 تم ازالة قوانين الجروب")  
...
send(msg.chat_id_, msg.id_," 𖢵 لا توجد قوانين")   
end    
end
...
send(msg.chat_id_, msg.id_,' 𖢵 تم طرد المحذوفين')
end,nil)
end
end
...
if #list == 0 then
send(msg.chat_id_, msg.id_,' 𖢵 لا توجد صلاحيات مضافه')
return false
end
t = "\n 𖢵 قائمة الصلاحيات المضافه \n𖣐━━━━━𖣐𝐒𝐀𝐈𝐃𝐈𖣐━━━━━𖣐\n"
for k,v in pairs(list) do
...
send(msg.chat_id_, msg.id_, " 𖢵 ارسل نوع الرتبه \n 𖢵 {عـضـو -- ممـيـز -- ادمـن -- مـديـر}") 
end
...
send(msg.chat_id_, msg.id_, "* 𖢵 تم مسح الصلاحيه *\n") 
end
...
if text == 'مدير' then
if not Constructor(msg) then
send(msg.chat_id_, msg.id_"* 𖢵 تستطيع اضافه صلاحيات {ادمن - مميز - عضو} \n 𖢵 ارسل الصلاحيه مجددا*\n") 
return false
end
end
if text == 'ادمن' then
if not Manager(msg) then 
send(msg.chat_id_, msg.id_,"* 𖢵 تستطيع اضافه صلاحيات {مميز - عضو} \n 𖢵 ارسل الصلاحيه مجددا*\n") 
return false
end
end
if text == 'مميز' then
if not Mod(msg) then
send(msg.chat_id_, msg.id_,"* 𖢵  تستطيع اضافه صلاحيات {عضو} \n 𖢵 ارسل الصلاحيه مجددا*\n") 
return false
end
end
...
send(msg.chat_id_, msg.id_, " 𖢵 تـم اضـافـه الامـر") 
database:del(bot_id.."Comd:New"..msg.chat_id_..""..msg.sender_user_id_) 
return false  
end 
end
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n 𖢵 الـعـضو   ↚ ['..result.title_..'](t.me/'..(text1[3] or 'textchuser')..')'..'\n 𖢵 تم رفعه '..text1[2]..'')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
send(msg.chat_id_, msg.id_,' 𖢵 تم مسح رسائلك'  )  
...
send(msg.chat_id_, msg.id_,' 𖢵 عدد رسائلك  ↚ { '..database:get(bot_id..'Msg_User'..msg.chat_id_..':'..msg.sender_user_id_)..'}' ) 
end 
...
if num > 1000 then 
send(msg.chat_id_, msg.id_,' 𖢵تستطيع التنظيف 1000 رساله كحد اقصى') 
return false  
end  
local msgm = msg.id_
for i=1,tonumber(num) do
...
send(msg.chat_id_,msg.id_,' 𖢵 تم مسح {'..num..'}')  
...
send(msg.chat_id_, msg.id_," 𖢵 تم تنظيف جميع الميديا")
end
...
local Message = v
if Message then
t = " 𖢵 تم مسح "..k.." من الوسائط الموجوده"
DeleteMessage(msg.chat_id_,{[0]=Message})
database:del(bot_id.."S00F4:allM"..msg.chat_id_)
end
end
if #list == 0 then
t = " 𖢵 لا يوجد ميديا في الجروب"
end
send(msg.chat_id_, msg.id_, t)
end
...
local numl = v
if numl then
l = " 𖢵 عدد الميديا الموجود هو "..k
end
end
if #num == 0 then
l = " 𖢵 لا يوجد ميديا في الجروب"
end
...
send(msg.chat_id_, msg.id_,' 𖢵 تم تنظيف جميع الرسائل المعدله')
end
...
database:setex(bot_id..'Set:Name:Bot'..msg.sender_user_id_,300,true) 
send(msg.chat_id_, msg.id_," 𖢵 ارسل لي الاسم الان ")  
end
return false
end
if msg.content_.ID == "MessageChatJoinByLink" then
...
send(msg.chat_id_, msg.id_,' 𖢵 الاذاعه معطله من قبل المطور الاساسي')
return false
end
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
...
if data.message_ == "CHAT_ADMIN_REQUIRED" then
send(msg.chat_id_,msg.id_," 𖢵 ليست لدي صلاحية تغير اسم الجروب")  
else
sebd(msg.chat_id_,msg.id_,' 𖢵 تم تغيير اسم الجروب الى {[「'..Name..'」]}')  
end
end,nil) 
end
...
send(msg.chat_id_, msg.id_," 𖢵 لا تستطيع تنزيل المطور الاساسي")
return false 
end
...
send(msg.chat_id_, msg.id_,"\n 𖢵 تم تنزيل الشخص من الرتب التاليه \n 𖢵  { "..dev..""..crr..""..cr..""..own..""..mod..""..mn..""..vip.." } \n")
else
send(msg.chat_id_, msg.id_,"\n 𖢵  عذرا الـعـضو  لايملك رتبه \n")
end
...
send(msg.chat_id_, msg.id_," 𖢵 تم مسح الردود العامه")
end

if text == ("الردود العامه") and DevSoFi(msg) then 
local list = database:smembers(bot_id..'List:Rd:Sudo')
text = "\n 𖢵 قائمة الردود العامه \n𖣐━━━━━𖣐𝐒𝐀𝐈𝐃𝐈𖣐━━━━━𖣐\n"
for k,v in pairs(list) do
...
send(msg.chat_id_, msg.id_,' 𖢵 تم حفظ الرد')
return false  
end  
end
if text and text:match("^(.*)$") then
if database:get(bot_id..'Set:Rd「'..msg.sender_user_id_..'」:'..msg.chat_id_) == 'true' then
send(msg.chat_id_, msg.id_,' 𖢵 ارسل الرد الذي تريد اضافته')
...
send(msg.chat_id_, msg.id_,' 𖢵 تم ازالة الرد العام')
...
send(msg.chat_id_, msg.id_,' 𖢵 ارسل الكلمه تريد اضافتها')
...
send(msg.chat_id_, msg.id_,' 𖢵 ارسل الكلمه تريد مسحها')
...
send(msg.chat_id_, msg.id_," 𖢵 تم مسح الرد من ردود المتعدده")
...
send(msg.chat_id_, msg.id_," 𖢵تم مسح ردود المتعدده")
end
------------------------------------------------------------------------
if text1 then 
...
send(msg.chat_id_, msg.id_," 𖢵 تم مسح الردود")
end
...
send(msg.chat_id_, msg.id_,' 𖢵 تم ازالة الرد ')
database:del(bot_id.."Add:Rd:Manager:Gif"..text..msg.chat_id_)   
database:del(bot_id.."Add:Rd:Manager:Vico"..text..msg.chat_id_)   
database:del(bot_id.."Add:Rd:Manager:Stekrs"..text..msg.chat_id_)     
database:del(bot_id.."Add:Rd:Manager:Text"..text..msg.chat_id_)   
...
send(msg.chat_id_, msg.id_,' 𖢵 ارسل الكلمه التي تريد اضافتها')
...
send(msg.chat_id_, msg.id_,' 𖢵 ارسل الكلمه التي تريد مسحها')
...
send(msg.chat_id_, msg.id_,' 𖢵لا يمكنني تعديل  او وضع لقب ليس لدي صلاحيه\n 𖢵قم بترقيتي جميع الصلاحيات او صلاحية اضافه مشرف ') 
return false  
end
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 𖢵 الـعـضو   ↚ ['..data.first_name_..'](t.me/'..(data.username_ or 'textchuser')..') '
status  = '\n 𖢵 الايدي  ↚ '..result.sender_user_id_..'\n 𖢵تم ضافه {'..timsh..'} كلقب له'
send(msg.chat_id_, msg.id_, usertext..status)
https.request("https://api.telegram.org/bot"..token.."/promoteChatMember?chat_id=" .. msg.chat_id_ .. "&user_id=" ..result.sender_user_id_.."&can_change_info=false&can_delete_messages=false&can_invite_users=True&can_restrict_members=false&can_pin_messages=True&can_promote_members=false")
...
function start_function(extra, result, success)
if msg.can_be_deleted_ == false then 
send(msg.chat_id_, msg.id_,' 𖢵 البوت ليس مشرف يرجى ترقيتي !') 
return false  
end
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 𖢵  الـعـضو   ↚ ['..data.first_name_..'](t.me/'..(data.username_ or 'textchuser')..')'
status  = '\n 𖢵  الايدي  ↚ `'..result.sender_user_id_..'`\n 𖢵  تم مسح لقبه من الجروب'
send(msg.chat_id_, msg.id_, usertext..status)
https.request("https://api.telegram.org/bot"..token.."/promoteChatMember?chat_id=" .. msg.chat_id_ .. "&user_id=" ..result.sender_user_id_.."&can_change_info=false&can_delete_messages=false&can_invite_users=false&can_restrict_members=false&can_pin_messages=false&can_promote_members=false")
end,nil)
end
...
send(msg.chat_id_, msg.id_,' 𖢵وينك وين القب ') 
else
send(msg.chat_id_, msg.id_,' 𖢵لقبك هو : '..GeId.result.custom_title) 
end
end
...
send(msg.chat_id_, msg.id_,'\n 𖢵صلاحيات البوت هي\n𖣐━━━━━𖣐𝐒𝐀𝐈𝐃𝐈𖣐━━━━━𖣐\n 𖢵  علامة ال {✔️} تعني مفعل\n 𖢵  علامة ال {✖} تعني غير مفعل\n𖣐━━━━━𖣐𝐒𝐀𝐈𝐃𝐈𖣐━━━━━𖣐\n 𖢵تغير معلومات المجموعة ↞ '..INf..'\n 𖢵مسح الرسائل ↞ '..DEL..'\n 𖢵حظر المستخدمين ↞ '..REs..'\n 𖢵دعوة المستخدمين ↞ '..INv..'\n 𖢵ثتبيت الرسالة ↞ '..Pin..'\n 𖢵اضافة مشرفين ↞ '..PRo)   
end
end
...
local t = "\n 𖢵المستخدم ~ ["..User_id .."] يصيح المشرفين \n𖣐━━━━━𖣐𝐒𝐀𝐈𝐃𝐈𖣐━━━━━𖣐\n"
k = 0
...
return send(msg.chat_id_, msg.id_," 𖢵ارسل الرد الذي اريد اضافته")
end
...
return send(msg.chat_id_, msg.id_," 𖢵ارسل الان الكلمه لمسحها ")
end
if text then  
...
send(msg.chat_id_, msg.id_," 𖢵تم حفظ الرد الاول ارسل الرد الثاني")
return false  
end  
end
if text then  
...
send(msg.chat_id_, msg.id_," 𖢵تم حفظ الرد الثاني ارسل الرد الثالث")
return false  
end  
end
if text then  
...
send(msg.chat_id_, msg.id_," 𖢵تم حفظ الرد")
return false  
end  
end
if text then
...
Text = ' 𖢵 تم تفعيل مغادرة البوت'
database:del(bot_id..'Left:Bot'..msg.chat_id_)  
else
Text = ' 𖢵 بالتاكيد تم تفعيل مغادرة البوت'
end
send(msg.chat_id_, msg.id_,Text) 
end
if text == 'تعطيل المغادره' and DevSoFi(msg) then  
if not database:get(bot_id..'Left:Bot'..msg.chat_id_) then
Text = ' 𖢵 تم تعطيل مغادرة البوت'
database:set(bot_id..'Left:Bot'..msg.chat_id_,true)   
else
Text = ' 𖢵 بالتاكيد تم تعطيل مغادرة البوت'
end
send(msg.chat_id_, msg.id_, Text) 
end
...
Text = '\n 𖢵 تم تفعيل الردود العامه' 
else
Text = '\n 𖢵 بالتاكيد تم تفعيل الردود العامه'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
Text = '\n 𖢵 تم تعطيل الردود العامه' 
else
Text = '\n 𖢵 بالتاكيد تم تعطيل الردود العامه'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
database:del(bot_id..'Bot:Id:Photo'..msg.chat_id_) 
Text = '\n 𖢵 تم تفعيل الايدي بالصور' 
else
Text = '\n 𖢵 بالتاكيد تم تفعيل الايدي بالصوره'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
if not database:get(bot_id..'Bot:Id:Photo'..msg.chat_id_)  then
database:set(bot_id..'Bot:Id:Photo'..msg.chat_id_,true) 
Text = '\n 𖢵 تم تعطيل الايدي بالصوره' 
else
Text = '\n 𖢵 بالتاكيد تم تعطيل الايدي بالصوره'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
send(msg.chat_id_, msg.id_,' 𖢵 ايديه ⇜ '..iduser..'\n 𖢵 معرفه ⇜ 「'..username..'」\n 𖢵 رتبته ⇜ '..rtp..'\n 𖢵 تعديلاته ⇜ '..edit..'\n 𖢵 نقاطه ⇜ '..NUMPGAME..'\n 𖢵 جهاته ⇜ '..Contact..'\n 𖢵 رسائله ⇜ 「'..Msguser..'」')
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
end
...
send(msg.chat_id_, msg.id_,' 𖢵 المعرف غير صحيح ')
end
end
tdcli_function ({ID = "SearchPublicChat",username_ = username}, start_function, nil)
end
...
send(msg.chat_id_, msg.id_," 𖢵تـم تـفعـيل انا مين") 
return false  
end
end
...
send(msg.chat_id_, msg.id_," 𖢵 تـم تـعـطـيل انا مين") 
return false end
end
if text == 'انا مين' and SudoBot(msg) then 
local my_ph = database:get(bot_id.."my_anamen:status"..msg.chat_id_)
if not my_ph then
send(msg.chat_id_, msg.id_," 𖢵انا مين معطله") 
return false  
end
send(msg.chat_id_,msg.id_, '[نت مطوري تاج راسي 😊](t.me/Sadauam)')
return false
end
...
send(msg.chat_id_, msg.id_," 𖢵تـم تـفعـيل ردود السورس") 
return false  
end
end
...
send(msg.chat_id_, msg.id_," 𖢵 تـم تـعـطـيل ردود السورس") 
return false end
end
...
send(msg.chat_id_,msg.id_, ' البوت شغال يا منيوك ') 
return false
end
...
send(msg.chat_id_,msg.id_, '[مع الف سلامه يقلبي متجيش تاني..😹💔🎶](t.me/Sadauam)')
return false
end
...
local my_ph = database:get(bot_id.."my_GHoeq2:status"..msg.chat_id_)
if not my_ph then
send(msg.chat_id_, msg.id_," 𖢵معطله") 
return false  
end
send(msg.chat_id_,msg.id_, '[باي..😺💜](t.me/Sadauam)')
return false
end
...
send(msg.chat_id_,msg.id_, '[نزل عينك تحت كدا علشان هتخاد علي قفاك..🌚♥️](t.me/Sadauam)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[انت الي حلو ياقمر..♥️🦋](t.me/Sadauam)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انا عايز مح انا كمان 🥺💛](t.me/Sadauam)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[وحيات امك ياكبتن خدوني معاكو بيف...🥺💔](t.me/Sadauam)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[بتعيط تيب لي طيب..😥](t.me/Sadauam)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[ونجيب اشخاص ...😂😜](t.me/Sadauam)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[بـعشـقق .🥰❤️](t.me/Sadauam)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[خخخ امال ..😹](t.me/Sadauam)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[قامد قموده ..🌝♥️](t.me/Sadauam)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[انا اجمد ..🌚💕](t.me/Sadauam)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[مش هروح ..😹👻](t.me/Sadauam)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[مش بدودو ..😹👻](t.me/Sadauam)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[الود كبر وبقي عندو بنت ..😻💥](t.me/Sadauam)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[عندو كام سنه ..😹💥](t.me/Sadauam)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[القمر مهو بيضكك اهوه ..🌚💕](t.me/Sadauam)')
return false
end
end
end
...
first_name = ' 𖢵 اسمك الاول  ↚ {`'..(result.first_name_)..'`}'
else
first_name = ''
end   
if result.last_name_ then 
last_name = ' 𖢵 اسمك الثاني  ↚ {`'..result.last_name_..'`}' 
else
last_name = ''
end      
...
if text == 'ايديي' then
send(msg.chat_id_, msg.id_,' 𖢵 ايديك  ↚ '..msg.sender_user_id_)
end
...
if msg.can_be_deleted_ == false then 
send(msg.chat_id_,msg.id_," 𖢵 البوت ليس ادمن \n") 
return false  
end 
tdcli_function({ID ="GetChat",chat_id_=msg.chat_id_},function(arg,ta) 
tdcli_function({ID="GetChannelFull",channel_id_ = msg.chat_id_:gsub('-100','')},function(arg,data) 
local sofi = ' 𖢵 عدد الادمنيه : '..data.administrator_count_..
'\n\n 𖢵 عدد المطرودين : '..data.kicked_count_..
'\n\n 𖢵 عدد الاعضاء : '..data.member_count_..
'\n\n 𖢵 عدد رسائل الجروب : '..(msg.id_/2097152/0.5)..
'\n\n 𖢵  اسم الجروب : ['..ta.title_..']'
...
send(msg.chat_id_, msg.id_, '\n 𖢵 عذرا لا استطيع طرد ( 「'..Rutba(msg.sender_user_id_,msg.chat_id_)..'」 )')
return false
end
...
send(msg.chat_id_, msg.id_,' 𖢵 عذرا لا استطيع طرد ادمنية الجروب') 
return false  
end
if data and data.ID and data.ID == 'Ok' then
send(msg.chat_id_, msg.id_,' 𖢵 تم طردك من الجروب') 
tdcli_function ({ ID = "ChangeChatMemberStatus", chat_id_ = msg.chat_id_, user_id_ = msg.sender_user_id_, status_ = { ID = "ChatMemberStatusLeft" },},function(arg,ban) end,nil)   
return false
end
end,nil)   
else
send(msg.chat_id_, msg.id_,' 𖢵 تم تعطيل امر اطردني') 
end
end
...
send(msg.chat_id_, msg.id_,' 𖢵 المعرف غلط ') 
return false  
end
if result and result.type_ and result.type_.channel_ and result.type_.channel_.ID == "Channel" then
send(msg.chat_id_, msg.id_,' 𖢵 لا استطيع اصيح معرف قنوات') 
return false  
end
if result.type_.user_.type_.ID == "UserTypeBot" then
send(msg.chat_id_, msg.id_,' 𖢵 لا استطيع اصيح معرف بوتات') 
return false  
end
...
if result.id_ then
send(msg.chat_id_, msg.id_,' 𖢵 😾تع يعم كلم الود دا قرفني [@「'..username..'」]') 
return false
end
end
tdcli_function ({ID = "SearchPublicChat",username_ = username}, start_function, nil)
else
send(msg.chat_id_, msg.id_,' 𖢵 تم تعطيل امر صيح') 
end
return false
end
...
send(msg.chat_id_, msg.id_,' 𖢵 انت منشئ الجروب') 
return false
end
...
local Name = '['..result.first_name_..'](tg://user?id='..result.id_..')'
Text = ' 𖢵 هوا ابن القمر دا الي ضافك😹 ↚ '..Name
sendText(msg.chat_id_,Text,msg.id_/2097152/0.5,'md')
end,nil)
else
send(msg.chat_id_, msg.id_,' 𖢵 انت دخلت عبر الرابط يوسخ 🌝') 
end
end,nil)
else
send(msg.chat_id_, msg.id_,' 𖢵 تم تعطيل امر  مين ضافني') 
end
end
...
tdcli_function ({ID = "GetUser",user_id_ = Added_Me},function(extra,result,success)
local Name = '['..result.first_name_..'](tg://user?id='..result.id_..')'
Text = ' 𖢵 هوا ابن الكلب دا الي ضافك😹 ↚ '..Name
sendText(msg.chat_id_,Text,msg.id_/2097152/0.5,'md')
end,nil)
else
send(msg.chat_id_, msg.id_,' 𖢵 انت دخلت عبر الرابط يوسخ 🌝') 
...
Text = ' 𖢵 تم تفعيل امر مين ضافني '
database:del(bot_id..'Added:Me'..msg.chat_id_)  
else
Text = ' 𖢵 بالتاكيد تم تفعيل امر مين ضافني '
end
send(msg.chat_id_, msg.id_,Text) 
end
...
Text = '\n 𖢵 تم تعطيل امر مين ضافني '
else
Text = '\n 𖢵 بالتاكيد تم تعطيل امر مين ضافني '
end
send(msg.chat_id_, msg.id_,Text) 
end
if text == 'تفعيل صيح' and Manager(msg) then   
if database:get(bot_id..'Seh:User'..msg.chat_id_) then
Text = ' 𖢵 تم تفعيل امر صيح'
database:del(bot_id..'Seh:User'..msg.chat_id_)  
else
Text = ' 𖢵 بالتاكيد تم تفعيل امر صيح'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
Text = '\n 𖢵 بالتاكيد تم تعطيل امر صيح'
end
send(msg.chat_id_, msg.id_,Text) 
end
if text == 'تفعيل اطردني' and Manager(msg) then   
if database:get(bot_id..'Cick:Me'..msg.chat_id_) then
Text = ' 𖢵 تم تفعيل امر اطردني إلى عايز يخرج يتنيل 😹'
database:del(bot_id..'Cick:Me'..msg.chat_id_)  
else
Text = ' 𖢵 بالتاكيد تم تفعيل امر اطردني مخلاص كفايه تفعيل الأمر 😾'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
Text = '\n 𖢵 تم تعطيل امر اطردني اترزع هن بقى مفيش خروج 😹'
else
Text = '\n 𖢵 بالتاكيد تم تعطيل امر اطردني مفيش خروج يولاد القمر 😹'
end
send(msg.chat_id_, msg.id_,Text) 
end
if text == "صورتي"  then
...
if not my_ph then
send(msg.chat_id_, msg.id_," 𖢵 الصوره معطله") 
return false  
end
local function getpro(extra, result, success)
if result.photos_[0] then
sendPhoto(msg.chat_id_, msg.id_, 0, 1, nil, result.photos_[0].sizes_[1].photo_.persistent_id_," 𖢵 عدد صورك ⇜ "..result.total_count_.." صوره‌‏", msg.id_, msg.id_, "md")
else
...
if not my_ph then
send(msg.chat_id_, msg.id_," 𖢵اكتب تفعيل نسبه جمالي") 
return false  
end
local function getpro(extra, result, success)
if result.photos_[0] then
sendPhoto(msg.chat_id_, msg.id_, 0, 1, nil, result.photos_[0].sizes_[1].photo_.persistent_id_," 𖢵نسبه جمالك هيا ⇜ %"..result.total_count_.." يختي قمر يجدعان 🌚💕", msg.id_, msg.id_, "md")
else
send(msg.chat_id_, msg.id_,'لا تمتلك صوره في حسابك', 1, 'md')
  end end
tdcli_function ({ ID = "GetUserProfilePhotos", user_id_ = msg.sender_user_id_, offset_ = 0, limit_ = 1 }, getpro, nil)
...
send(msg.chat_id_, msg.id_, '\n 𖢵 الصوره ⇜ ليس لديك صور في حسابك'..'[\n¦• 𝚄𝚂𝙴𝚁 ↬ 「'..username..'」\n¦• 𝙼𝚂𝙶𝚂↬ 「'..Msguser..'」\n¦• 𝙸𝙳↬  「'..msg.sender_user_id_..'」\n¦• 𝒄𝒉↬  「@Sadauam」\n')
end 
end
end
else
...
send(msg.chat_id_, msg.id_,' 𖢵 تم تغير الايدي ارسل ايدي لرؤيته')
end

if text == 'سحكاتي' or text == 'تعديلاتي' then 
local Num = tonumber(database:get(bot_id..'edits'..msg.chat_id_..msg.sender_user_id_) or 0)
if Num == 0 then 
Text = ' 𖢵  ليس لديك سحكات'
else
Text = ' 𖢵 عدد سحكاتك * ↚ 「 '..Num..' 」 *'
end
send(msg.chat_id_, msg.id_,Text) 
end
if text == "مسح سحكاتي" or text == "مسح سحكاتي" then  
send(msg.chat_id_, msg.id_,' 𖢵 تم مسح سحكاتك'  )  
database:del(bot_id..'edits'..msg.chat_id_..msg.sender_user_id_)
end
if text == "مسح جهاتي" or text == "مسح جهاتي" then  
send(msg.chat_id_, msg.id_,' 𖢵 تم مسح جهاتك'  )  
...
if Num == 0 then 
Text = ' 𖢵 لم تقم بأضافه احد'
else
Text = ' 𖢵 عدد جهاتك * ↚ 「 '..Num..' 」 *'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
-- vardump(data) 
BANDAdx(msg.chat_id_, msg.id_, ' 𖢵 ايدي المجموعة  ↚ 「 '..msg.chat_id_..' 」\n 𖢵 عدد الادمنيه  ↚ 「 *'..data.administrator_count_..' 」*\n 𖢵 عدد المحظورين  ↚ 「 *'..data.kicked_count_..' 」*\n 𖢵 عدد الاعضاء  ↚ 「 *'..data.member_count_..' 」*\n', 'md') 
end 
...
send(msg.chat_id_, msg.id_," 𖢵 تم اضافة له {"..numadded..'} من الرسائل')  
end
------------------------------------------------------------------------
...
send(msg.chat_id_, msg.id_,  1, " 𖢵| تم اضافة له {"..numadded..'} من النقود', 1 , 'md')  
end
------------------------------------------------------------
...
send(msg.chat_id_, msg.id_, ' 𖢵 ارسل لي عدد الرسائل الان') 
return false
end
------------------------------------------------------------------------
...
send(msg.chat_id_, msg.id_, ' 𖢵 ارسل لي عدد النقاط التي تريد اضافتها') 
return false
end
------------------------------------------------------------------------
if text and text:match("^اضف نقاط (%d+)$") and msg.reply_to_message_id_ ~= 0 and Constructor(msg) then
...
send(msg.chat_id_, msg.id_," 𖢵 تم اضافة له {"..Num..'} من النقاط')  
end
...
if Num == 0 then 
Text = ' 𖢵 لم تلعب اي لعبه للحصول على نقاط'
else
Text = ' 𖢵 عدد نقاطك التي ربحتها هيه * ↚ 「 '..Num..' 」 نقاط *'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
send(msg.chat_id_,msg.id_,"\n* 𖢵 لا استطيع البيع اقل من 1 *") 
return false 
end
if tonumber(database:get(bot_id..'NUM:GAMES'..msg.chat_id_..msg.sender_user_id_)) == tonumber(0) then
send(msg.chat_id_,msg.id_,' 𖢵 ليس لديك نقاط في الالعاب\n 𖢵 اذا كنت تريد ربح نقاط \n 𖢵 ارسل الالعاب وابدأ اللعب ! ') 
else
local NUM_GAMES = database:get(bot_id..'NUM:GAMES'..msg.chat_id_..msg.sender_user_id_)
if tonumber(NUMPY) > tonumber(NUM_GAMES) then
send(msg.chat_id_,msg.id_,'\n 𖢵 ليس لديك نقاط في هذه لعبه \n 𖢵 لزيادة نقاطك في اللعبه \n 𖢵 ارسل الالعاب وابدأ اللعب !') 
return false 
end
local NUMNKO = (NUMPY * 50)
database:decrby(bot_id..'NUM:GAMES'..msg.chat_id_..msg.sender_user_id_,NUMPY)  
database:incrby(bot_id..'Msg_User'..msg.chat_id_..':'..msg.sender_user_id_,NUMNKO)  
send(msg.chat_id_,msg.id_,' 𖢵 تم خصم * ↚ { '..NUMPY..' }* من نقاطك \n 𖢵 وتم اضافة*  ↚ { '..(NUMPY * 50)..' } رساله الى رسالك *')
end 
return false 
end
...
send(msg.chat_id_,msg.id_,'\n 𖢵 اهلا عزيزي البوت هنا ادمن'..'\n 𖢵 وصلاحياته هي ↓ \n━━━━━━━━━━'..'\n 𖢵 تغير معلومات الجروب ↞ ❴ '..info..' ❵'..'\n 𖢵 مسح الرسائل ↞ ❴ '..delete..' ❵'..'\n 𖢵 حظر المستخدمين ↞ ❴ '..restrict..' ❵'..'\n 𖢵 دعوة مستخدمين ↞ ❴ '..invite..' ❵'..'\n 𖢵 تثبيت الرسائل ↞ ❴ '..pin..' ❵'..'\n 𖢵 اضافة مشرفين جدد ↞ ❴ '..promote..' ❵')   
end
end
end
...
send(msg.chat_id_, msg.id_," 𖢵 تم تغير رد المطور الى  ↚ "..Teext)
end
...
send(msg.chat_id_, msg.id_, ' 𖢵 تم استعادة الاوامر القديمه')
end
if text == 'تغير امر الاوامر' and DevSoFi(msg) then
send(msg.chat_id_, msg.id_, ' 𖢵 الان يمكنك ارسال الكليشه الاوامر')
database:set(bot_id..'help'..msg.sender_user_id_,'true')
return false 
end
if text == 'تغير امر ⓵' and DevSoFi(msg) then
send(msg.chat_id_, msg.id_, ' 𖢵 الان يمكنك ارسال الكليشه ⓵')
...
send(msg.chat_id_, msg.id_, ' 𖢵 تم تعطيل حساب العمر')
...
send(msg.chat_id_, msg.id_,' 𖢵 تم تفعيل حساب العمر')
...
send(msg.chat_id_, msg.id_," 𖢵تـم تـفعـيل مريم") 
return false  
end
end
...
send(msg.chat_id_, msg.id_," 𖢵 تـم تـعـطـيل مريم") 
return false end
end
if text == "مريم" then
local my_ph = database:get(bot_id.."my_maryam:status"..msg.chat_id_)
if not my_ph then
send(msg.chat_id_, msg.id_," 𖢵مريم  معطله") 
return false  
end
if not database:get(bot_id..'lock:add'..msg.chat_id_) then
...
local Teext =[[
 ...
 𖢵❲ الادمن❳ ⇊
 𖣐━━━━━𖣐𝐒𝐀𝐈𝐃𝐈𖣐━━━━━𖣐
 𖢵 رفع مميز ⇔ تنزيل مميز
 𖢵 الترحيب
 𖢵 اضف مغادره ⇔ مسح المغادره
 𖢵 رساله المغادره
 𖢵 كشف البوتات
 𖢵 المميزين ⇔  مسح المميزين
 𖢵 حظر ⇔ الغاء حظر
 𖢵 كتم ⇔ الغاء كتم
 𖢵 حظر لمده + المده
 𖢵 كتم لمده + المده
 𖢵 طرد ⇔ تطهير 
 𖢵 تثبيت ⇔ تثبيت بدون اشعار
 𖢵 الغاء تثبيت الكل
 𖢵  ❲ + ❳ جميع ماسبق
 𖣐━━━━━𖣐𝐒𝐀𝐈𝐃𝐈𖣐━━━━━𖣐
 𖢵 ❲ المنشئ❳ ⇊
 ...
 𖢵 ايقاف المنشن
 𖢵 تعيين ⇔ مسح  ❲ الايدي ❳
 𖢵 الادمنيه ⇔  مسح الادمنيه
 𖢵 اضف ترحيب
 𖢵  مسح المحظورين ⇔ المكتومين
 𖢵 منع + الكلمه
 𖢵 الغاء منع + الكلمه
 𖢵  مسح الكلمات الممنوعه
 𖢵 المميزين عام
 𖢵  ❲ + ❳ جميع ماسبق
 𖣐━━━━━𖣐𝐒𝐀𝐈𝐃𝐈𖣐━━━━━𖣐
 𖢵 ❲ المالك❳ ⇊
 𖣐━━━━━𖣐𝐒𝐀𝐈𝐃𝐈𖣐━━━━━𖣐
 𖢵 اضف صوره ⇔ وصف (للجروب)
 𖢵 رفع منشئ ⇔ تنزيل منشئ
 𖢵 تاج للاعضاء ⇔ للكل
 𖢵 اضف رابط ⇔ مسح الرابط
 𖢵 اضف ⇔  مسح  ❲ امر ❳
 𖢵 الاوامر المضافه
 𖢵  مسح الاوامر المضافه
 𖢵 ضع اسم+الاسم ⇔ تحديث
 𖢵 المنشئين ⇔  مسح المنشئين
 𖢵  ❲ + ❳ جميع ماسبق
 𖣐━━━━━𖣐𝐒𝐀𝐈𝐃𝐈𖣐━━━━━𖣐
❲[𝗦𝗔𝗜𝗗𝗜 𖢜 ](t.me/Sadauam)❳ 
]]
...
local Teext =[[
 𖢵مرحب بيك في اوامر الوضع واضف 𖢵
𖣐━━━━━𖣐𝐒𝐀𝐈𝐃𝐈𖣐━━━━━𖣐 
 𖢵اوامر الوضع - اضف
𖣐━━━━━𖣐𝐒𝐀𝐈𝐃𝐈𖣐━━━━━𖣐
 𖢵اضف / مسح ← رد
...
𖣐━━━━━𖣐𝐒𝐀𝐈𝐃𝐈𖣐━━━━━𖣐
 ...
 𖢵امسح
 𖢵صلاحيه
 𖢵قائمه منع المتحركات
 𖢵قائمه منع الصور
 𖢵قائمه منع الملصقات
 𖢵مسح قائمه المنع
 𖢵المحذوفين
𖣐━━━━━𖣐𝐒𝐀𝐈𝐃𝐈𖣐━━━━━𖣐
 𖢵مسح  امر + الامر القديم  
𖣐━━━━━𖣐𝐒𝐀𝐈𝐃𝐈𖣐━━━━━𖣐
 𖢵الاوامر المضافه ( لعرض الاوامر المضافه ) 
𖣐━━━━━𖣐𝐒𝐀𝐈𝐃𝐈𖣐━━━━━𖣐
❲[𝗦𝗔𝗜𝗗𝗜 𖢜 ](t.me/Sadauam)❳ 
]]
keyboard = {} 
...
local Teext =[[
 𖢵مرحب بيك في اوامر تنزيل ورفع 𖢵
𖣐━━━━━𖣐𝐒𝐀𝐈𝐃𝐈𖣐━━━━━𖣐 
 𖢵اوامر تنزيل ورفع
𖣐━━━━━𖣐𝐒𝐀𝐈𝐃𝐈𖣐━━━━━𖣐 
 𖢵مميز
...
𖣐━━━━━𖣐𝐒𝐀𝐈𝐃𝐈𖣐━━━━━𖣐
 𖢵تغير رد المطور + اسم
 𖢵تغير رد المالك + اسم
 𖢵تغير رد منشئ الاساسي + اسم
 𖢵تغير رد المنشئ + اسم
 𖢵تغير رد المدير + اسم
 𖢵تغير رد الادمن + اسم
 𖢵تغير رد المميز + اسم
 𖢵تغير رد الـعـضو  + اسم
 𖢵تغير امر الاوامر
 𖢵تغير امر م1 ~ الئ م10
𖣐━━━━━𖣐𝐒𝐀𝐈𝐃𝐈𖣐━━━━━𖣐 
 𖢵اوامر الجروب 📢 .
𖣐━━━━━𖣐𝐒𝐀𝐈𝐃𝐈𖣐━━━━━𖣐
 𖢵استعاده الاوامر 
 𖢵تحويل كالاتي⇜ بالرد على صوره او ملصق او صوت او بصمه بالامر ← تحويل 
 𖢵صيح ~ تاك ~ المميزين : الادمنيه : المدراء : المنشئين : المنشئين الاساسين
 𖢵كشف القيود
 𖢵تعين الايدي
 𖢵تغير الايدي
 𖢵الحساب + ايدي الحساب
...
┇~ الصور + متحركه + ملصق ~
 𖢵حظر ~ كتم ~ تقيد ~ طرد
 𖢵المحظورين ~ المكتومين ~ المقيدين
 𖢵الغاء كتم + حظر + تقيد ~ بالرد و معرف و ايدي
 𖢵تقيد ~ كتم + الرقم + ساعه
 𖢵تقيد ~ كتم + الرقم + يوم
 𖢵تقيد ~ كتم + الرقم + دقيقه
 𖢵تثبيت ~ الغاء تثبيت
 𖢵الترحيب
 𖢵الغاء تثبيت الكل
 𖢵كشف البوتات
...
{
{text = 'Back 𖢵', callback_data="/help8"},
},
}
return https.request("https://api.telegram.org/bot"..token..'/editMessageText?chat_id='..Chat_id..'&text='..URL.escape(Teext)..'&message_id='..msg_idd..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard)) 
end
...
local Teext =[[
 𖢵مرحب بيك في اوامر للمطورين 𖢵
اوامر المطورين ⇊
❲المطرو❳  ⇊
𖣐━━━━━𖣐𝐒𝐀𝐈𝐃𝐈𖣐━━━━━𖣐
 𖢵تفعيل ← تعطيل 
 𖢵المجموعات ← المشتركين ← الاحصائيات
 𖢵رفع ← تنزيل منشئ اساسي
 𖢵مسح الاساسين ← المنشئين الاساسين
 𖢵مسح المنشئين ← المنشئين
 𖢵اسم ~ ايدي + بوت غادر 
 𖢵اذاعه 
𖣐━━━━━𖣐𝐒𝐀𝐈𝐃𝐈𖣐━━━━━𖣐
...
𖣐━━━━━𖣐𝐒𝐀𝐈𝐃𝐈𖣐━━━━━𖣐
 ...
 𖢵المنشئين الاساسين
 𖢵رفع/تنزيل منشئ اساسي
 𖢵رفع/تنزيل مطور اساسي 
 𖢵  رفع/تنزيل مدير عام
 𖢵  رفع /تنزيل ادمن عام
 𖢵مسح المطورين
 𖢵المطورين
 𖢵رفع | تنزيل مطور
 𖢵اسم البوت + غادر
 ...
 𖢵جلب نسخه البوت
 𖢵رفع نسخه البوت
 𖢵ضع عدد الاعضاء + العدد
 𖢵ضع كليشه المطور
 𖢵تفعيل/تعطيل الاذاعه
 𖢵تفعيل/تعطيل البوت الخدمي
 𖢵تفعيل/تعطيل التواصل
 𖢵تغير اسم البوت
 𖢵اضف/مسح رد عام
 𖢵الردود العامه
 𖢵مسح الردود العامه
 𖢵الاشتراك الاجباري
 𖢵تعطيل الاشتراك الاجباري
 𖢵تفعيل الاشتراك الاجباري
 𖢵مسح رساله الاشتراك
 𖢵تغير رساله الاشتراك
 𖢵تغير الاشتراك
 𖢵الاحصائيات
 𖢵المشتركين
 𖢵المجموعات 
 𖢵تفعيل/تعطيل المغادره
 𖢵مسح الجروبات
𖣐━━━━━𖣐𝐒𝐀𝐈𝐃𝐈𖣐━━━━━𖣐
❲[𝗦𝗔𝗜𝗗𝗜 𖢜 ](t.me/Sadauam)❳ 
]]
...
━ ━ ━ ━ ━ ━ ━ ━ ━ ━ ━ ━ ━ ━ 
 𖢵 اهلا بك عزيزي 🔊
 𖢵 اوامر مطور الاساسي 👨🏼‍✈️
•┉ • ┉ • ┉ 𝔓𝔒𝔚𝔈ℜ ┉ • ┉ • ┉•
 𖢵 تفعيل
 𖢵 تعطيل
 𖢵 مسح الاساسين
 𖢵 المنشئين الاساسين
 𖢵 رفع/تنزيل منشئ اساسي
 𖢵 رفع/تنزيل مطور اساسي 
 𖢵 مسح المطورين
 𖢵 المطورين
 𖢵 رفع | تنزيل مطور
•┉ • ┉ • ┉ 𝔓𝔒𝔚𝔈ℜ ┉ • ┉ • ┉•
...
•┉ • ┉ • ┉ 𝔓𝔒𝔚𝔈ℜ ┉ • ┉ • ┉•
 ...
 𖢵 اذاعه
 𖢵 اذاعه بالتوجيه
 𖢵 اذاعه بالتوجيه خاص
 𖢵 اذاعه بالتثبيت
•┉ • ┉ • ┉ 𝔓𝔒𝔚𝔈ℜ ┉ • ┉ • ┉•
 𖢵 جلب نسخه البوت
 𖢵 رفع نسخه البوت
 𖢵 ضع عدد الاعضاء + العدد
 𖢵 ضع كليشه المطور
 𖢵 تفعيل/تعطيل الاذاعه
 𖢵 تفعيل/تعطيل البوت الخدمي
 𖢵 تفعيل/تعطيل التواصل
 𖢵 تغير اسم البوت
 𖢵 اضف/مسح رد عام
 𖢵 الردود العامه
 𖢵 مسح الردود العامه
•┉ • ┉ • ┉ 𝔓𝔒𝔚𝔈ℜ ┉ • ┉ • ┉•
 𖢵 الاشتراك الاجباري
 𖢵 تعطيل الاشتراك الاجباري
 𖢵 تفعيل الاشتراك الاجباري
 𖢵 مسح رساله الاشتراك
 𖢵 تغير رساله الاشتراك
 𖢵 تغير الاشتراك
•┉ • ┉ • ┉ 𝔓𝔒𝔚𝔈ℜ ┉ • ┉ • ┉•
 𖢵 الاحصائيات
 𖢵 المشتركين
 𖢵 المجموعات 
 𖢵 تفعيل/تعطيل المغادره
 𖢵 مسح الجروبات
•┉ • ┉ • ┉ 𝔓𝔒𝔚𝔈ℜ ┉ • ┉ • ┉•
➫ .[🖨┇𝚂𝙾𝚄𝚁𝙲𝙴𝚂 𝙿??𝚆𝙴𝚁.](t.me/sopowerb0t)➤
]]
keyboard = {} 
keyboard.inline_keyboard = {
{
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'لعبه البات', url="https://t.me/Sadauam/5"},{text = 'لعبه الرياضيات',url="https://t.me/Sadauam/6"}},   
{{text = 'لعبه المختلف', url="https://t.me/Sadauam/15"},{text = 'لعبه السمايلات', url="https://t.me/Sadauam/8"}}, 
{{text = 'لعبه التخمين', url="https://t.me/Sadauam/10"},{text = 'لعبه العكس', url="https://t.me/Sadauam/11"}}, 
{{text = 'لعبه الاسرع', url="https://t.me/Sadauam/12"},{text = 'لعبه الانكليزي', url="https://t.me/Sadauam/13"}}, 
{{text = 'لعبه حزوره', url="https://t.me/Sadauam/9"},{text = 'لعبه المعاني', url="https://t.me/Sadauam/14"}}, 
{{text = 'لعبه الامثله', url="https://t.me/Sadauam/7"},{text = 'عقاب', url="https://t.me/Sadauam/30"}},
{{text = 'مريم', url="https://t.me/Sadauam/35"}},
{{text = '◗القائمه الرائسيه◖', callback_data="/add"}},
{{text = '˹ᴊᴏɪɴ⌁ѕᴀɪᴅɪ˼', url="t.me/Sadauam"}},
}
return https.request("https://api.telegram.org/bot"..token..'/editMessageText?chat_id='..Chat_id..'&text='..URL.escape(Teext)..'&message_id='..msg_idd..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard)) 
...
local Teext =[[
𐇣اهلا بك في مميزات سورس الصعيدي𐇣
𐇣مميزات الخاصه بسورس الصعيدي𐇣
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'تويت', url="https://t.me/Sadauam"},{text = 'كتبات',url="https://t.me/Sadauam/21"}},   
{{text = 'انصحني', url="https://t.me/Sadauam"},{text = 'لو خيروك', url="https://t.me/Sadauam/18"}}, 
{{text = 'الصراحه', url="https://t.me/Sadauam"},{text = 'حروف', url="https://t.me/Sadauam/19"}}, 
{{text = 'رزله', url="https://t.me/Sadauam"},{text = 'رد عليه يابوت', url="https://t.me/Sadauam/26"}}, 
{{text = 'بتكره دا', url="https://t.me/Sadauam"},{text = 'نكته', url="https://t.me/Sadauam/20"}}, 
{{text = 'غنيلي', url="https://t.me/Sadauam"}},
{{text = 'نسبه جمالي', url="https://t.me/Sadauam"},{text = 'اليتيوب', url="https://t.me/Sadauam/29"}},
{{text = '◗القائمه الرائسيه◖', callback_data="/add"}},
{{text = '˹ᴊᴏɪɴ⌁ѕᴀɪᴅɪ˼', url="t.me/Sadauam"}},
}
return https.request("https://api.telegram.org/bot"..token..'/editMessageText?chat_id='..Chat_id..'&text='..URL.escape(Teext)..'&message_id='..msg_idd..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard)) 
...
send(msg.chat_id_, msg.id_,' 𖢵 تم مسح الامر')  
else
send(msg.chat_id_, msg.id_,' 𖢵 لا يوجد امر بهاذا الاسم')  
end
...
send(msg.chat_id_, msg.id_, ' 𖢵 تم تعطيل اوامر التسليه')
database:set(bot_id.."Fun_Bots:"..msg.chat_id_,"true")
end
if (text and text == "تفعيل اوامر التسليه") then 
send(msg.chat_id_, msg.id_, ' 𖢵  تم تفعيل اوامر التسليه')
...
send(msg.chat_id_,0,''..t..'\n𖣐━━━━━𖣐𝐒𝐀𝐈𝐃𝐈𖣐━━━━━𖣐\n 𖢵 تم التعديل على الميديا\n 𖢵 الشخص الي قام بالتعديل\n 𖢵 ايدي الشخص ◂ '..result.sender_user_id_..'\n 𖢵 معرف الشخص ↚{ '..users..' }') 
end,nil)
...
if BANDA1_Msg then    
send(msg.chat_id_, msg.id_," 𖢵 "..BANDA1_Msg)
