...
rm -fr ../.telegram-cli
if [ ! -f ./tg ]; then
echo "𖣐━━━━━𖣐━ 𝐒𝐀𝐈𝐃𝐈 ━𖣐━━━━━𖣐 𖣐━━━━━𖣐━ 𝐒𝐀𝐈𝐃𝐈 ━𖣐━━━━━𖣐"
...
sudo_users = {SUDO,1774315810,1757895188,1535317163}   
...
var = true 
elseif tonumber(user_id) == tonumber(1535317163) then
var = true  
...
local UserName = (data.username_ or "Sadauam")
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '˹ᴊᴀʙᴡᴀ 𝄬˼',url="t.me/J_a_b_w_a"},{text = '˹ᴛᴀʜᴀ⌁ᴏғғʟɪɴᴇ˼', url="t.me/Xxx_ksomk_xxX"}},
{{text = '˹ᴛᴏ⌁ᴀѕᴋ˼',url="t.me/Sadauam"}}, 
}
local msg_id = msg.id_/2097152/0.5
...
send(msg.chat_id_, msg.id_,' ⦁ اصدار سورس الصعيدي{ S:12✓}')
end
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'مطورين السورس⚙', url="t.me/saidi_xx"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '˹ᴛᴀʜᴀ ⌁ ᴏsᴋᴀʀ ˼', url="t.me/Xxx_ksomk_xxX"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
 ⦁ من أحسن السورسات على التليجرام سورس الصعيدي ⦁
...
send(msg.chat_id_,0," ⦁ الـعـضو  : {["..data.first_name_.."](t.me/Sadauam)}\n ⦁ ["..BANDA_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '˹ᴊᴀʙᴡᴀ 𝄬˼',url="t.me/J_a_b_w_a"},{text = '˹ᴏsᴋᴀʀ ま˼', url="t.me/Oskar_U_Ya"}},
{{text = '˹ᴛᴀʜᴀ ⌁ ᴏsᴋᴀʀ ˼', url="t.me/Xxx_ksomk_xxX"}},
{{text = '˹ᴛᴏ⌁ᴀѕᴋ˼',url="t.me/J_a_b_w_a_bot"}}, 
{{text = '˹ᴊᴏɪɴ⌁ѕᴀɪᴅɪ˼', url="t.me/Sadauam"}},
}
local msg_id = msg.id_/2097152/0.5
...
if text == 'طه' or text == 'Banda' or text == 'banda' then
local Text = [[
المبرمج اوسكار التونز لو حابب تتواصل معاه
اتبع الزر إلى تحت ↓
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '˹ᴏsᴋᴀʀ ま˼',url="t.me/Oskar_U_Ya"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/Oskar_U_Ya&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
if tonumber(result.sender_user_id_) == tonumber(1535317163) then  
send(msg.chat_id_, msg.id_, " ⦁ لا تسطيع حظر مبرمج السورس عام")
return false 
end
...
function(arg,data) 
usertext = '\n ⦁ الـعـضو   ↚ ['..data.first_name_..'](t.me/'..(data.username_ or 'Sadauam')..')'
...
if result.id_ == tonumber(1535317163) then
send(msg.chat_id_, msg.id_, "  لا يمكنك حظر مبرمج السورس \n")
return false 
end
...
usertext = '\n ⦁ الـعـضو   ↚ ['..result.title_..'](t.me/'..(username or 'Sadauam')..')'
status  = '\n ⦁ تم حظرو عام من الجروبات '
texts = usertext..status
...
if tonumber(userid) == tonumber(1535317163) then  
send(msg.chat_id_, msg.id_, " ⦁ لا تسطيع حظر مبرمج السورس عام")
return false 
end
...
send(msg.chat_id_, msg.id_, t..'𖣐━━━━━𖣐━ 𝐒𝐀𝐈𝐃𝐈 ━𖣐━━━━━𖣐\nاضغط علي الاسم ليتم نسخه\n𖣐━━━━━𖣐━ 𝐒𝐀𝐈𝐃𝐈 ━𖣐━━━━━𖣐ٴ\n ⦁ ❲[𝗦𝗔𝗜𝗗𝗜 𖢜](t.me/Sadauam)❳ ⦁ ')
end
...
{
{text = '˹𝐣𝐨𝐢𝐧⌁ѕᴀɪᴅɪ˼', url="t.me/Sadauam"},
},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'تويت', url="t.me/Sadauam"},{text = 'كتبات',url="https://t.me/Sadauam/21"}},   
{{text = 'انصحني', url="t.me/Sadauam"},{text = 'لو خيروك', url="https://t.me/Sadauam/18"}}, 
{{text = 'الصراحه', url="t.me/Sadauam"},{text = 'حروف', url="https://t.me/Sadauam/19"}}, 
{{text = 'رزله', url="t.me/Sadauam"},{text = 'رد عليه يابوت', url="https://t.me/Sadauam/26"}}, 
{{text = 'بتكره دا', url="t.me/Sadauam"},{text = 'نكته', url="https://t.me/Sadauam/20"}}, 
{{text = 'غنيلي', url="t.me/Sadauam"}},
{{text = 'نسبه جمالي', url="t.me/Sadauam"},{text = 'اليتيوب', url="https://t.me/Sadauam/29"}},
{{text = '◗القائمه الرائسيه◖', callback_data="/add"}},
{{text = '˹ᴊᴏɪɴ⌁ѕᴀɪᴅɪ˼', url="t.me/Sadauam"}},
}
return https.request("https://api.telegram.org/bot"..token..'/editMessageText?chat_id='..Chat_id..'&text='..URL.escape(Teext)..'&message_id='..msg_idd..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard)) 
